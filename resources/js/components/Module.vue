<template>
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
          ...
          <table id="tbl_main_module" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr v-for="(module,index) in modules" height="15">
              ...
              <td>
                ...
                <button v-show="delete_permission" class="btn btn-danger btn-sm"
                        @click.prevent="deletemodule(module.id)">Delete
                </button>
              </td>
            </tr>
            </tbody>
      ...
      <!--  MOdel  -->
      <div class="modal fade" id="addNewModule" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
           aria-hidden="true">
