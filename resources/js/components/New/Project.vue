<template>
  <fieldset>
    <form id="msform" @submit.prevent="editmode ? updateProject() : createCompanyProfile()"
        ...
        <div v-if="list_showable" class="card-body">
          ...
          <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
            ...
            <template #project_name="data">
              <span class="font-semibold">{{ data.value.project_name }}</span>
            </template>
            <template #subject_title="data">
              <span class="font-semibold">{{ data.value.subject_title }}</span>
            </template>
            <template #current_status="data">
              <span class="font-semibold">{{ data.value.current_status }}</span>
            </template>
            <template #building_type="data">
              <span class="font-semibold">{{ data.value.building_type }}</span>
            </template>
            <template #building_name="data">
              <span class="font-semibold">{{ data.value.building_name }}</span>
            </template>
            <template #contractor_id_no="data">
              <span class="font-semibold">{{ data.value.contractor_id_no }}</span>
            </template>
            <template #contractor_name="data">
              <span class="font-semibold">{{ data.value.contractor_name }}</span>
            </template>
            <template #buttons="data">
              <button class="btn btn-primary btn-sm" @click.prevent="editPropertyProject(data.value.id)">Edit</button>
            </template>
          </vue3-datatable>
        </div>
        <div v-if="!list_showable">
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> General Information:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="general_info_show">Hide
              </button>
            </h3>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Building Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_building()"
                      v-show="!building_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_building()" v-show="building_show">
                Hide
              </button>
            </h3>
                      ...
                      <tr align="center">
                        ...
                        <td>
                          <select v-model="form.residential_building_id"
                            ...
                            <option value="null" v-if="form.residential_building_id===null">--Select Property ID--
                            </option>
                            <option value="" v-else>--Select Property ID--</option>
                            <template v-for="(building,index) in building_arr">
                              <option :value="index" v-if="building.residential==1">{{ building.building_no }}</option>
                            </template>
                          </select>
                        </td>
                      ...
                      <tr align="center">
                        ...
                        <td>
                          <select v-model="form.commercial_building_id"
                            ...
                            <template v-for="(building,index) in building_arr">
                              <option :value="index" v-if="building.commercial==1">{{ building.building_no }}</option>
                            </template>
                          </select>
                        </td>
                      ...
                      <tr align="center">
                        ...
                        <td>
                          <select v-model="form.residential_commercial_building_id"
                            ...
                            <option value="">--Select Property ID--</option>
                            <template v-for="(building,index) in building_arr">
                              <option :value="index" v-if="building.residential_commercial==1">{{ building.building_no }}</option>
                            </template>
                          </select>
                        </td>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Floor Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_floor_list()" v-show="!floor_show">
                Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_floor_list()" v-show="floor_show">
                Hide
            ...
            <div class="form-holder" v-show="floor_show">
              <div class="form-folder" style="margin-left:50px;4">
                <table class="table table_narrow">
                  ...
                  <tbody>
                  <template v-for="(floor,index) in form.floor_arr">
                    <template v-if="floor.data_exist">
                      <tr>
                        <td align="center">Floor No-{{ floor.floor_no }}</td>
                        <td align="center">{{ floor.system_no }}</td>
                        <td align="center">{{ floor.floor_name }}</td>
                        <td align="center">
                          <button type="button" class="btn btn-primary btn-sm" @click="show_hide_floor(floor)"
                                  v-show="!floor.toggle">Show
                          </button>
                          <button type="button" class="btn btn-primary btn-sm" @click="show_hide_floor(floor)"
                                  v-show="floor.toggle">Hide
                          </button>
                        </td>
                      </tr>
                                        ...
                                        <tr style=" background-color:#ababab;font-size:20; font-color:#ddd">
                                          <td>
                                            <button type="button" class="btn btn-primary btn-sm"
                                                    @click="show_hide_suite(s_suite)" v-show="!s_suite.toggle">Show
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm"
                                                    @click="show_hide_suite(s_suite)" v-show="s_suite.toggle">Hide
                                            </button>
                                          </td>
                                          <td v-if="s_suite.suite_type==1"><strong>Studio</strong></td>
                                          <td v-else-if="s_suite.suite_type==2"><strong>1 Bedroom </strong></td>
                                          ...
                                          <td><strong>Suite-{{ s_suite.suite_no.toString().padStart(2, "0") }}</strong>
                                          </td>
                                        </tr>
                                  ...
                                  <div class="form-box-outer" style=" width:100%">
                                    <table class="table table_narrow">
                                      ...
                                      <template v-for="(unit,index) in form.unit_arr[floor.floor_id]">
                                        <tr align="center"
                                            style=" background-color:#ababab;font-size:20; font-color:#ddd">
                                          <td>
                                            <button type="button" class="btn btn-primary btn-sm"
                                                    @click="show_hide_unit(unit)" v-show="!unit.toggle">Show
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm"
                                                    @click="show_hide_unit(unit)" v-show="unit.toggle">Hide
                                            </button>
                                          </td>
                                  ...
                                  <div class="form-box-outer" style=" width:100%">
                                    <table class="table table_narrow">
                                      ...
                                      <template v-if="floor.machanical">
                                        ...
                                        <template v-for="(single_subroom,index) in form.service_room_arr[floor.floor_id]">
                                          <template v-if="single_subroom.item_type==7">
                                            <tr>
                                              ...
                                              <td width="25%" scope="row" style="padding-left:2% !important">
                                                <strong>{{ single_subroom.item_name }}</strong></td>
                                              <td width="20%">
                                                {{ single_subroom.system_no }}
                                              </td>
                                      ...
                                      <template v-if="floor.administritive">
                                        ...
                                        <template v-for="(single_subroom,index) in form.service_room_arr[floor.floor_id]">
                                          <template v-if="single_subroom.item_type==8">
                                            <tr>
                                              <td class="form-check-inline">
                                                <input type="checkbox"
                                                       id="allocated"
                                      ...
                                      <template v-if="floor.aminity">
                                        ...
                                        <template v-for="(single_subroom,index) in form.service_room_arr[floor.floor_id]">
                                          <template v-if="single_subroom.item_type==9">
                                            <tr>
                                              <td class="form-check-inline">
                                                <input type="checkbox"
                                                       id="allocated"
                                      ...
                                      <template v-if="floor.service">
                                        ...
                                        <template v-for="(single_subroom,index) in form.service_room_arr[floor.floor_id]">
                                          <template v-if="single_subroom.item_type==10">
                                            <tr>
                                              <td class="form-check-inline">
                                                <input type="checkbox"
                                                       id="allocated"
                            ...
                            <div class="form-holder">
                              <div class="row align-self-stretch">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                                  <div class="form-box-outer" style=" width:100%">
                                    <div class="my-2">
                                      <input type="text" class="form-control" v-model="filter_parking" placeholder="Search..." style="width:400px;"/>
                                    </div>
                                    <vue3-datatable :rows="form.parking_stall_arr[floor.floor_id]" :columns="parking_columns" :sortable="true" :search="filter_parking" class="advanced-table whitespace-nowrap">
                                      <template #buttons="data">
                                        <input type="checkbox"
                                               id="allocated"
                                               @click="check_parking_stall($event,data.value)"
                                               name="allocated[]"
                                               v-model="data.value.allocated">
                                        <label for="allocated"></label><br>
                                      </template>
                                      <template #mst_property_name="data">
                                        <span class="font-semibold">{{ data.value.mst_property_name }}</span>
                                      </template>
                                      <template #item_name="data">
                                        <span class="font-semibold">{{ data.value.item_name }}</span>
                                      </template>
                                      <template #system_no="data">
                                        <span class="font-semibold">{{ data.value.system_no }}</span>
                                      </template>
                                      <template #property_name="data">
                                        <span class="font-semibold">{{ data.value.property_name }}</span>
                                      </template>
                                      <template #parking_level="data">
                                        <span class="font-semibold">{{ data.value.parking_level }}</span>
                                      </template>
                                    </vue3-datatable>
                                  </div>
                                </div>
                            ...
                            <div class="form-holder">
                              <div class="row align-self-stretch">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                                  <div class="form-box-outer" style=" width:100%">
                                    <div class="my-2">
                                      <input type="text" class="form-control" v-model="filter_bike" placeholder="Search..." style="width:400px;"/>
                                    </div>
                                    <vue3-datatable :columns="bike_columns" :rows="form.bike_stall_arr[floor.floor_id]" :sortable="true" :search="filter_bike" class="advanced-table whitespace-nowrap">
                                      <template #buttons="data">
                                        <input type="checkbox"
                                               id="allocated"
                                               @click="check_bike_stall($event,data.value)"
                                               name="allocated[]"
                                               v-model="data.value.allocated">
                                        <label for="allocated"></label><br>
                                      </template>
                                      ...
                                      <template #bike_level="data">
                                        <span class="font-semibold">{{ data.value.bike_level }}</span>
                                      </template>
                                    </vue3-datatable>
                                  </div>
                                </div>
                            ...
                            <div class="form-holder">
                              <div class="row align-self-stretch">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                                  <div class="form-box-outer" style=" width:100%">
                                    <div class="mb-2">
                                      <input type="text" class="form-control" v-model="filter_storage" placeholder="Search..." style="width:400px;"/>
                                    </div>
                                    <vue3-datatable :columns="storage_columns" :rows="form.storage_locker_arr[floor.floor_id]" :sortable="true" :search="filter_storage" class="advanced-table whitespace-nowrap">
                                      <template #buttons="data">
                                        <input type="checkbox"
                                               id="allocated"
                                               @click="check_storage_locker($event,data.value)"
                                               name="allocated[]"
                                               v-model="data.value.allocated">
                                        <label for="allocated"></label><br>
                                      </template>
                                      ...
                                      <template #storage_level="data">
                                        <span class="font-semibold">{{ data.value.storage_level }}</span>
                                      </template>
                                    </vue3-datatable>
                                  </div>
                                </div>
                            ...
                            <div class="form-holder">
                              <div class="row align-self-stretch">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                                  <div class="form-box-outer" style=" width:100%">
                                    <div class="mb-2">
                                      <input type="text" class="form-control" v-model="filter_mailbox" placeholder="Search..." style="width:400px;"/>
                                    </div>
                                    <vue3-datatable :columns="mail_columns" :rows="form.mail_box_arr[floor.floor_id]" :sortable="true" :search="filter_mailbox" class="advanced-table whitespace-nowrap">
                                      <template #buttons="data">
                                        <input type="checkbox"
                                               id="allocated"
                                               @click="check_mail_box($event,data.value)"
                                               name="allocated[]"
                                               v-model="data.value.allocated">
                                        <label for="allocated"></label><br>
                                      </template>
                            ...
                            <div class="form-holder">
                              <div class="row align-self-stretch">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                                  <div class="form-box-outer" style=" width:100%">
                                    <div class="mb-2">
                                      <input type="text" class="form-control" v-model="filter_common_area" placeholder="Search..." style="width:400px;"/>
                                    </div>
                                    <vue3-datatable :columns="common_area_columns" :rows="form.common_area_arr[floor.floor_id]" :sortable="true" :search="filter_common_area" class="advanced-table whitespace-nowrap">
                                      <template #buttons="data">
                                        <input type="checkbox"
                                               id="allocated"
                                               @click="check_common_area($event,data.value)"
                                               name="allocated[]"
                                               v-model="data.value.allocated">
                                        <label for="allocated"></label><br>
                                      </template>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Service Provider Insurance Package
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_insurance()"
                      v-show="!insurance_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_insurance()"
                      v-show="insurance_show">Hide
              </button>
            </h3>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Project Duration
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_project_duration()"
                      v-show="!project_duration_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_project_duration()"
                      v-show="project_duration_show">Hide
              </button>
            </h3>
                          ...
                          <tr style="background-color: #e7e8e7">
                            ...
                            <td>
                              <date-picker
                                  ...
                                  :class="{ 'is-invalid': form.errors.has('from_date') }"
                              />
                            </td>
                            <td>
                              <date-picker
                                  ...
                                  :class="{ 'is-invalid': form.errors.has('to_date') }"
                              />
                            </td>
                            <td>
                              <input
                          ...
                          <tr style="background-color: #e7e8e7">
                            <td scope="row" width="25%">
                              <button type="button" class="btn btn-success btn-sm"
                                      @click="add_new_project_duration(index)"
                                      v-if="index+1==form.project_duration_arr.length">Add
                              </button>
                      ...
                      <tr style="background-color: rgb(0, 112, 192);color:#fff">
                        ...
                        <td scope="row">
                          <date-picker
                              ...
                              :class="{ 'is-invalid': form.errors.has('final_delivery_date') }"
                          />
                        </td>
                      </tr>
                      </tbody>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Timeline
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_timeline()"
                      v-show="!timeline_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_timeline()" v-show="timeline_show">
                Hide
              </button>
            </h3>
                      ...
                      <template v-for="(timeline,index) in form.timeline_arr">
                        <tr style="background-color: #e7e8e7">
                          <td scope="row" width="5%">
                            <button type="button" class="btn btn-success btn-sm" @click="add_new_timeline()"
                                    v-if="index+1==form.timeline_arr.length">+
                            </button>
                            {{ index + 1 }}
                          </td>
                          <td>
                          ...
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('resedule_from_date1') }"
                            />
                          </td>
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('resedule_to_date1') }"
                            />
                          </td>
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('resedule_from_date2') }"
                            />
                          </td>
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('resedule_to_date2') }"
                            />
                          </td>
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('resedule_from_date3') }"
                            />
                          </td>
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('resedule_to_date3') }"
                            />
                          </td>
                          <td>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Amount
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_amount()" v-show="!amount_show">
                Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_amount()" v-show="amount_show">
                Hide
                ...
                <div class="col-md-8 col-sm-12 col-xs-12" style="margin-bottom:20px">
                  <div class="form-box-outer" style=" width:100%">
                    <table class="table table_narrow">
                      ...
                      <tbody style="border:none">
                      <template v-for="(project_amount,index) in form.project_amount_arr">
                        <template v-if="project_amount.type==1">
                          <tr>
                      ...
                      <template v-for="(project_amount,index) in form.project_amount_arr">
                        <template v-if="project_amount.type==2">
                          <tr>
                            <td scope="row" width="20%">
                              <input
                                  type="text"
                            ...
                            <td scope="row" width="20%">
                              <button type="button" class="btn btn-success btn-sm" @click="add_new_amount(1)"
                                      v-if="project_amount.sl==form.additional_amount_sl">Add
                              </button>
                            </td>
                          </tr>
                        </template>
                      ...
                      <template v-for="(project_amount,index) in form.project_amount_arr">
                        <template v-if="project_amount.type==3">
                          <tr>
                            <td scope="row" width="20%">
                              <input
                                  type="text"
                            ...
                            <td scope="row" width="10%">
                              <button type="button" class="btn btn-success btn-sm" @click="add_new_amount(2)"
                                      v-if="project_amount.sl==form.deduction_amount_sl">Add
                              </button>
                            </td>
                          </tr>
                        </template>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Payments Schedule
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_payment_schedule()"
                      v-show="!payment_schedule_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_payment_schedule()"
                      v-show="payment_schedule_show">Hide
              </button>
            </h3>
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                                ...
                                v-if="payment_schedule.is_callender">Remove From Calender
                            </button>
                            ...
                            <button
                                ...
                                v-else>Add To Calender
                            </button>
                          </td>
                          <td scope="row" width="20%">
                            <button type="button" class="btn btn-success btn-sm" @click="add_new_payment_schdule(1)"
                                    v-if="payment_schedule.sl==form.payment_schedule_sl">Add
                            </button>
                          </td>
                        </tr>
                      </template>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Incident Reports
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_incident_reports()"
                      v-show="!incident_reports_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_incident_reports()"
                      v-show="incident_reports_show">Hide
              </button>
            </h3>
                        ...
                        <tr>
                          <td>
                            <date-picker
                                ...
                                :class="{ 'is-invalid': form.errors.has('incident_date') }"
                            />
                          </td>
                          <td scope="row" width="20%">
                            <input
                          ...
                          <td scope="row" width="20%">
                            <button type="button" class="btn btn-success btn-sm" @click="add_new_incident_report()"
                                    v-if="incident_report.sl==form.incident_report_sl">Add
                            </button>
                          </td>
                        </tr>
                      </template>
          ...
          <div class="text-center" v-if="!list_showable">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="editmode" @click.prevent="deletePropertyProject()">Delete
            </button>
            <button :disabled="form.busy" type="submit" class="btn  btn-primary" style="min-width:110px"
      ...
      <!--  MOdel  -->
      <div class="modal fade model-middle" id="ServiceProvider" tabindex="-1" role="dialog"
            ...
            <div class="modal-body" style="height: 50vh; overflow-y: auto;">
              <div class="form-holder">
                <table class="table">
                  ...
                  <tbody>
                  <tr v-for="service_provider in service_provider_arr" style="cursor:pointer"
                      @click="close_service_provider(service_provider)">
                    <td>{{ service_provider.first_name }} {{ service_provider.middle_name }}
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Project ID', field: 'system_no'},
        {title: 'Project Name', field: 'project_name'},
        {title: 'Subject Title', field: 'subject_title'},
        {title: 'Current Status', field: 'current_status'},
        {title: 'Building Type', field: 'building_type'},
        {title: 'Building Name', field: 'building_name'},
        {title: 'Contactor ID', field: 'contractor_id_no'},
        {title: 'Contactor Name', field: 'contractor_name'},
      ...
      parking_columns: ref([
        {title: 'Action', field: 'buttons', sort: false},
        {title: 'Parking Lot No', field: 'mst_property_name'},
        {title: 'Stall No', field: 'item_name'},
        {title: 'Property ID', field: 'system_no'},
        {title: 'Property Name', field: 'property_name'},
        {title: 'Level No', field: 'parking_level'},
      ]),

      bike_columns: ref([
        {title: 'Action', field: 'buttons', sort: false},
        {title: 'Bike Lot No', field: 'mst_property_name'},
        {title: 'Stall No', field: 'item_name'},
        {title: 'Property ID', field: 'system_no'},
        {title: 'Property Name', field: 'property_name'},
        {title: 'Level No', field: 'bike_level'},
      ]),

      storage_columns: ref([
        {title: 'Action', field: 'buttons', sort: false},
        {title: 'Storage Lot No', field: 'mst_property_name'},
        {title: 'Stall No', field: 'item_name'},
        {title: 'Property ID', field: 'system_no'},
        {title: 'Property Name', field: 'property_name'},
        {title: 'Level No', field: 'storage_level'},
      ]),

      mail_columns: ref([
        {title: 'Action', field: 'buttons', sort: false},
        {title: 'Mailroom No', field: 'mst_property_name'},
        {title: 'Mailbox No', field: 'item_name'},
        {title: 'Property ID', field: 'system_no'},
        {title: 'Property Name', field: 'property_name'},
      ]),

      common_area_columns: ref([
        {title: 'Action', field: 'buttons', sort: false},
        {title: 'Common Area', field: 'item_name'},
        {title: 'Property ID', field: 'system_no'},
        {title: 'Property Name', field: 'property_name'},
      ]),

      supporting_columns: ref([
        {title: 'Action', field: 'buttons', sort: false},
        {title: 'Common Area', field: 'item_name'},
        {title: 'Property ID', field: 'system_no'},
        {title: 'Property Name', field: 'property_name'},
  ...
  methods: {
    ...
    fetchPropertyProject() {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.timeline_arr.push({
          ...
          'from_date': null,
          'to_date': null,
          'resedule_from_date1': null,
          'resedule_to_date1': null,
          'resedule_from_date2': null,
          'resedule_to_date2': null,
          'resedule_from_date3': null,
          'resedule_to_date3': null,
          'task_status': '',
        });
    ...
    editPropertyProject(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.parking_stall_arr = ref(response.data.parking_stall_arr);
        this.form.parking_lot_arr = ref(response.data.parking_lot_arr);
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.property_project_list);
      });
