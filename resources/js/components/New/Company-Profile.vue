          ...
          <form id="msform" @submit.prevent="editmode ? updateCompanyProfile() : createCompanyProfile()" @keydown="form.onKeydown($event)">
            <fieldset>
                      ...
                      <div class="row align-self-stretch">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="form-box-outer">
                            ...
                            <div v-if="form.errors.has('business_registration_number')"
                                 v-html="form.errors.get('business_registration_number')"/>
                          ...
                          <div class="form-box-outer">
                            ...
                            <div class="position-relative form-group">
                              <select v-model="form.recuring_cycle"
                                ...
                                <template  v-for="year in 25">
                                  <option :value="year" v-if="year>1">{{ year }} Years</option>
                                </template>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form-box-outer">
                            <table class="table table-bordered">
                              ...
                              <tr v-for="(government_account,index) in form.government_account_lavel_data">
                                <th width="20%" scope="row" v-if="government_account.reference_id"><h6>
                                  {{ government_account.reference_value }}</h6></th>
                                <td width="20%" v-else>
                                  <input
                                      type="text"
                                ...
                                <td width="15%" align="center">
                                  <div class="form-check-inline">
                                    <button
                                        ...
                                        v-if="government_account.is_callender">Remove From Calender
                                    </button>
                              ...
                              <tr>
                                <td colspan="5">
                                  <button
                                      type="button"
                                      class="btn  btn-primary"
                                      @click="add_govt_account()">Add New Accounts
                                  </button>
                                </td>
                              </tr>
                              </tbody>
              ...
              <div class="text-center">
                ...
                <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                        v-show="editmode" @click.prevent="deleteCompany()">Delete
                </button>
                <button :disabled="form.busy" type="submit" class="btn  btn-primary" style="min-width:110px"
  ...
  methods: {
    ...
    fetchCompanyProfileUpdate(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        if(count(response.data.company_data) > 0)
        {
          ...
          this.form.registration_date =  response.data.company_data[0].registration_date && response.data.company_data[0].registration_date !== "" ?
              new Date(response.data.company_data[0].registration_date) : null;
          ...
          this.form.expirey_date = response.data.company_data[0].expirey_date && response.data.company_data[0].expirey_date !== "" ?
              new Date(response.data.company_data[0].expirey_date) : null;
          ...
          this.form.fiscal_year_start_date = response.data.company_data[0].fiscal_year_start_date && response.data.company_data[0].fiscal_year_start_date !== "" ?
              new Date(response.data.company_data[0].fiscal_year_start_date) : null;
          this.form.fiscal_year_end_date =  response.data.company_data[0].fiscal_year_end_date && response.data.company_data[0].fiscal_year_end_date !== "" ?
              new Date(response.data.company_data[0].fiscal_year_end_date) : null;
        ...
        for (let i = 0; i < response.data.government_account_data_arr.length; i++) {
          this.form.government_account_lavel_data.push({
            ...
            'filling_date': response.data.government_account_data_arr[i].filling_date && response.data.government_account_data_arr[i].filling_date !== "" ?
                new Date(response.data.government_account_data_arr[i].filling_date) : null,
