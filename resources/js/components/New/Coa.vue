<template>
  <section class="app-main__inner">
    <div class="container-fluid">
            ...
            <div class="form-card">
              <div class="form-folder">
                ...
                <div class="form-holder">
                  <button :disabled="form.busy" type="button" class="btn  btn-primary"
                          style="min-width:110px;border-radius:50rem " @click="addNewAccount(0,0,0,0)">Add New Account
                  </button>
                  <div class="row align-self-stretch">
                    <table class="table">
                      ...
                      <tr>
                        <td v-for="(sub_group,index) in accounts_sub_group" style="padding:.1rem">
                          <a :class="{active:selected_sub_group==index}" href="JavaScript:void(0);"
                             @click="load_sub_group_data(index)" style="font-size:11px;"
                             v-if="sub_level_total[index]>0">{{ sub_group }}({{ sub_level_total[index] }}) </a>
                          <a :class="{active:selected_sub_group==index}" href="JavaScript:void(0);"
                             @click="load_sub_group_data(index)" style="font-size:11px;" v-else>{{ sub_group }}(0)
                    ...
                    <table class="table table_narrow">
                      ...
                      <template v-for="(sub_group, index) in coa_setting_sub_lavel_arr[selected_sub_group]">
                        <tr>
                          <td colspan="6" class="text-left" style="background-color:rgba(169, 190, 217, 0.52);color:#000">
                            {{ sub_group.account_title }}
                          </td>
                        ...
                        <template v-if=" selected_sub_group in coa_arr">
                          <template v-for="(temp_sub_group, sb_index) in coa_arr">
                            <template v-if="sb_index==selected_sub_group">
                              <template v-if=" index in temp_sub_group">
                                <template v-for="(temp_second_level, sm_index) in temp_sub_group">
                                  <template v-if="sm_index==index">
                                    <template v-for="(temp_third_level, tm_index) in temp_second_level">
                                      <template v-if="tm_index==0">
                                        <template v-for="(temp_forth_level, fm_index) in temp_third_level">
                                          <template v-if="fm_index==0">
                                            <tr style="background-color:rgb(250,253,243)">
                                              ...
                                              <td colspan="2" class="text-left" style="color:#000;"
                                                  v-if="selected_sub_group==7 || selected_sub_group==10">Sales Tax
                                              </td>
                                              <td colspan="2" class="text-left" style="color:#000;"
                                                  v-else-if="selected_sub_group==9 || selected_sub_group==11">Purchase Tax
                                              </td>
                                            ...
                                            <template v-for="(temp_coa, c_index) in temp_forth_level">
                                              <tr>
                                                <td colspan="2" class="text-left"
                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"></td>
                                                <td colspan="2" class="text-left"
                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                  {{ temp_coa.account_no }}
                                                </td>
                                                <td colspan="2" class="text-left"
                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                  {{ temp_coa.description }}
                                                </td>
                                                <td colspan="2" class="text-left"
                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                  {{ temp_coa.govt_tax_code }}
                                                </td>
                                                <td colspan="2" class="text-left"
                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                  {{ temp_coa.tax_code }}
                                                ...
                                                <td colspan="2" class="text-left"
                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"
                                                    @click="edit_chart_of_account(selected_sub_group,index,0,0,temp_coa)"><i
                                            ...
                                            <tr>
                                              ...
                                              <td colspan="10" class="text-left"
                                                ...
                                                <a href="JavaScript:void(0);" style="color:blue;cursor:pointer;"
                                                   @click="addNewAccount(selected_sub_group,index,0,0)">
                              ...
                              <template v-else>
                                <tr>
                                  ...
                                  <td colspan="5" class="text-left"
                                      style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">No Item in
                                    {{ sub_group.account_title }}
                                    <a href="JavaScript:void(0);" style="color:blue;cursor:pointer;"
                                       @click="addNewAccount(selected_sub_group,index,0,0)">
                                      <i class="fa fa-plus-circle" aria-hidden="false"></i> Add New Account No
                        ...
                        <template v-for="(temp_sub_group, s_index) in coa_setting_second_lavel_arr[selected_sub_group]">
                          <template v-if="index==s_index">
                            <template v-for="(second_level, index1) in temp_sub_group">
                              <tr>
                                <td style="background-color:rgba(218, 229, 243, 0.37);color:#000"></td>
                                <td colspan="5" class="text-left"
                                    style="background-color:rgba(218, 229, 243, 0.37);color:#000">
                                  {{ second_level.account_title }}
                                </td>
                                    ...
                                    <template v-if="index in temp_sub_group">
                                      <template v-for="(temp_second_level, sm_index) in temp_sub_group">
                                        <template v-if="sm_index==index">
                                              ...
                                              <template v-if="tm_index==index1">
                                                ...
                                                <template v-if="fm_index==0">
                                                  <tr style="background-color:rgb(250,253,243)">
                                                    ...
                                                    <td colspan="2" class="text-left" style="color:#000;">Description</td>
                                                    <td colspan="2" class="text-left" style="color:#000;">Govt. Tax Code</td>
                                                    <td colspan="2" class="text-left" style="color:#000;" v-if="selected_sub_group==7 || selected_sub_group==10">
                                                      Sales Tax
                                                    </td>
                                                    <td colspan="2" class="text-left" style="color:#000;"
                                                        v-else-if="selected_sub_group==9 || selected_sub_group==11">Purchase Tax
                                                  ...
                                                  <template v-for="(temp_coa, c_index) in temp_forth_level">
                                                    <tr>
                                                      ...
                                                      <td colspan="2" class="text-left" style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                        {{ temp_coa.account_no }}
                                                      </td>
                                                      <td colspan="2" class="text-left"
                                                          style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                      ...
                                                      <td colspan="2" class="text-left"
                                                          style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"
                                                          @click="edit_chart_of_account(selected_sub_group,index,index1,0,temp_coa)">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td colspan="10" class="text-left" style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                      <a href="JavaScript:void(0);" style="color:blue; cursor:pointer;"
                                                         @click="addNewAccount(selected_sub_group,index,index1,0)">
                                                        <i class="fa fa-plus-circle" aria-hidden="false"></i> Add New Account No
                                                      </a>
                                                    </td>
                                                  </tr>
                                          ...
                                          <tr>
                                            <td colspan="2" width="10%" class="text-left" style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"></td>
                                            <td colspan="10" class="text-left" style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">No Item in
                                              {{ second_level.account_title }}
                                              <a href="JavaScript:void(0);" style="color:blue; cursor:pointer;"
                                                 @click="addNewAccount(selected_sub_group,index,index1,0)">
                                                <i class="fa fa-plus-circle" aria-hidden="false"></i> Add New Account No
                              ...
                              <template
                                  v-for="(sub_group_data, t_index1) in coa_setting_third_lavel_arr[selected_sub_group]">
                                <template v-for="(second_level_data, t_index2) in sub_group_data">
                                  <template v-if="t_index2==index1">
                                    <template v-for="(third_level_data, t_index3) in second_level_data">
                                      <tr>
                                        ...
                                        <td colspan="4" class="text-left"
                                            style="background-color:rgba(211, 236, 243, 0.15);color:#000">
                                          {{ third_level_data.account_title }}
                                        </td>
                                        <td colspan="6" class="text-left"
                                            style="background-color:rgba(211, 236, 243, 0.15);color:#000"></td>
                                      </tr>
                                      <!---------------------  third lavel coa-------------->
                                                ...
                                                <template v-if="sm_index==index">
                                                  <template v-if=" index1 in temp_second_level">
                                                    <template v-for="(temp_third_level, tm_index) in temp_second_level">
                                                      <template v-if="tm_index==index1">
                                                        <template v-for="(temp_forth_level, fm_index) in temp_third_level">
                                                          <template v-if="fm_index==t_index3">
                                                            <tr style="background-color:rgb(250,253,243)">
                                                              <td colspan="3" class="text-left" style="color:#000;"></td>
                                                              <td colspan="2" class="text-left" style="color:#000;">Account No</td>
                                                              <td colspan="2" class="text-left" style="color:#000;">Description</td>
                                                              <td colspan="2" class="text-left" style="color:#000;">Govt. Tax Code
                                                              </td>
                                                              <td colspan="2" class="text-left" style="color:#000;"
                                                                  v-if="selected_sub_group==7 || selected_sub_group==10">Sales Tax
                                                              </td>
                                                              <td colspan="2" class="text-left" style="color:#000;"
                                                                  v-else-if="selected_sub_group==9 || selected_sub_group==11">
                                                                Purchase Tax
                                                              </td>
                                                              <td colspan="2" class="text-left" style="color:#000;" v-else></td>
                                                            ...
                                                            <template v-for="(temp_coa, c_index) in temp_forth_level">
                                                              <tr>
                                                                <td colspan="3" width="15%" class="text-left"
                                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"></td>
                                                                <td colspan="2" class="text-left"
                                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">
                                                                  {{ temp_coa.account_no }}
                                                                ...
                                                                <td colspan="1" class="text-left"
                                                                    style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"
                                                                    @click="edit_chart_of_account(selected_sub_group,index,index1,t_index3,temp_coa)">
                                                            ...
                                                            <tr>
                                                              ...
                                                              <td colspan="9" class="text-left"
                                                                ...
                                                                <a href="JavaScript:void(0);" style="color:blue; cursor:pointer;"
                                                                   @click="addNewAccount(selected_sub_group,index,index1,t_index3)">
                                                                  <i class="fa fa-plus-circle" aria-hidden="false"></i> Add New
                                                                  Account No
                                                                </a>
                                                              </td>
                                                            </tr>
                                                  ...
                                                  <tr>
                                                    <td colspan="3" class="text-left"
                                                        style="color:#000; border-bottom:2px solid rgb(191, 191, 193)"></td>
                                                    <td colspan="9" class="text-left"
                                                        style="color:#000; border-bottom:2px solid rgb(191, 191, 193)">No Item
                                                      in {{ second_level.account_title }}

                                                      <a href="JavaScript:void(0);" style="color:blue; cursor:pointer;"
                                                         @click="addNewAccount(selected_sub_group,index,index1,t_index3)">
                                                        <i class="fa fa-plus-circle" aria-hidden="false"></i> Add New Account
                                                        No
                                                      </a>
                                                    </td>
                                                  </tr>
      ...
      <!--  MOdel  -->
      <div class="modal fade model-middle" id="coaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
           z-index="1000" aria-hidden="true">
                  ...
                  <div class="row align-self-stretch">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-box-outer">
                        <div class="row">
                          ...
                          <div class="col-md-9 col-sm-6 col-xs-12">
                            <select v-model="form.sub_group"
                              ...
                              <option v-for="(sub_group, index) in accounts_sub_group" :value="index">{{ sub_group }}
                              </option>
                            </select>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-9 col-sm-6 col-xs-12">
                            <select v-model="form.second_level"
                              ...
                              <option disabled value="0">--Select--</option>
                              <option v-for="(sub_group, index) in coa_setting_sub_lavel_arr[form.sub_group]"
                                      :value="index">{{ sub_group.account_title }}
                              </option>
                            </select>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-9 col-sm-6 col-xs-12">
                            <select v-model="form.third_level"
                              ...
                              <template
                                  v-for="(temp_second_level,s_level) in coa_setting_second_lavel_arr[form.sub_group]">
                                <option v-for="(third_level, index1) in temp_second_level" :value="index1"
                                        v-if="s_level==form.second_level">{{ third_level.account_title }}
                                </option>
                              </template>
                            </select>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-9 col-sm-6 col-xs-12">
                            <select v-model="form.forth_level"
                              ...
                              <option disabled value="0">--Select--</option>
                              <template
                                  v-for="(temp_second_level,sec_level) in coa_setting_third_lavel_arr[form.sub_group]">
                                <template v-for="(temp_third_level,t_level) in temp_second_level"
                                          v-if="sec_level==form.second_level">
                                  <option v-for="(forth_level, index2) in temp_third_level" :value="index2"
                                          v-if="t_level==form.third_level">{{ forth_level.account_title }}
                                  </option>
                                </template>
                              </template>
                            </select>
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="modelClose()">
                          Close
                        </button>
