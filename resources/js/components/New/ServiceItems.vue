                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-box-outer">
                    ...
                    <select v-model="form.service_category"
                      ...
                      <option v-for="service_category in service_category_arr" :value="service_category.id">
  ...
  methods: {
    ...
    addNewCustomField() {
      if (!this.form.custom_field_name) {
        showToast('Please Select Service Category Name', 'warning');
        return;
      }
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.service_item_list);
      });
