      ...
      <div class="form-card">
        ...
        <div v-if="list_showable" class="card-body">
          ...
          <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
            ...
            <template #buttons="data">
              <button class="btn btn-primary btn-sm" @click.prevent="editTax(data.value.id)">Edit</button>
        ...
        <div v-if="!list_showable">
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Inventory Items:</h3>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="form-box-outer">
                    ...
                    <select v-model="form.item_category"
                      ...
                      <option v-for="(item_category,index) in item_category_arr" :value="index">{{ item_category }}
                      </option>
                    </select>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="form-box-outer">
                    ...
                    <select v-model="form.purchase_tax"
                      ...
                      <option disabled value="">--Select--</option>
                      <option v-for="(purchase_tax,index) in purchase_tax_arr" :value="index">{{ purchase_tax }}
                      </option>
                    </select>
      ...
      <div class="modal fade model-middle" id="customAccountTypeModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="modelClose()">Close</button>
              <button type="button" class="btn btn-primary" @click.prevent="addNewCustomField(form.custom_tax_type)"
                      v-if="form.custom_tax_type==1">Add Staff and Departments
              </button>
              <button type="button" class="btn btn-primary" @click.prevent="addNewCustomField(form.custom_tax_type)"
                      v-if="form.custom_tax_type==2">Add Repair and Maintenance
              </button>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows =  ref(response.data.inventory_item_list);
      });
