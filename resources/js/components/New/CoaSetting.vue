  ...
  <section class="app-main__inner">
    <div class="container-fluid">
      <div class="row justify-content-center">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="form-box-outer">
                            <table class="table table_narrow">
                              ...
                              <template v-for="(coa_setting_main_level,index) in form.coa_setting_arr">
                                <template v-if="index>0">
                                  <template v-for="(coa_setting_sub_level,index1) in coa_setting_main_level">
                                      ...
                                      <template v-for="(coa_setting_forth_level,index3) in coa_setting_third_level">
                                        <template v-for="(coa_setting,rid) in coa_setting_forth_level" v-if="index2==0 && index3==0">
                                          <tr>
                                            ...
                                            <td align="left"
                                                style="background-color:rgb(238, 229, 201); margin-bottom:2px"><h6>
                                              {{ coa_setting.account_title }} </h6></td>
                                            <td width="8%">
                                            ...
                                            <template v-for="(rid_forth_level,forth_index) in coa_setting_sub_level[rid]">
                                              <template v-for="(coa_setting_custom,trid) in rid_forth_level" v-if="forth_index==0">
                                                <tr>
                                                  ...
                                                  <td align="left" style="background-color:rgb(196, 190, 171); margin-bottom:2px">
                                                    <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ coa_setting_custom.account_title }} </h6>
                                                  </td>
                                                  <td width="8%">
                                                    <div class="form-check-inline">
                                                      <input
                                                ...
                                                <template v-if="trid in coa_setting_sub_level[rid]">
                                                  <template v-for="(trid_forth_level,frid) in coa_setting_sub_level[rid][trid]">
                                                    <tr>
                                                      ...
                                                      <td align="left" style="background-color:rgb(223, 220, 210); margin-bottom:2px">
                                                        <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{
                                                            trid_forth_level.account_title
                                                          }}</h6>
                                                      </td>
                                                      <td width="8%">
                                                        <div class="form-check-inline">
                                    ...
                                    <tr>
                                      <td colspan="2"></td>
                                      <td align="left" style="cursor:pointer"><h4
                                          @click="add_coa_setting_row(coa_setting_sub_level,index,index1)">Add </h4></td>
                                      <td colspan="6"></td>
                                    </tr>
                                  </template>
                                </template>
        ...
        <!--  MOdel  -->
        <div class="modal fade model-middle" id="coaModal" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel" z-index="1000" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <form id="msform" @submit.prevent="editmodeCustom ? updateCustomCoa() : createCustomCoa()"
                            ...
                            <div class="col-md-7 col-sm-6 col-xs-12">
                              <select v-model="form1.custom_level_three"
                                ...
                                <template v-for="(coa_setting_third_level,index2) in custom_coa_setting_sub_level">
                                  <template v-for="(coa_setting_forth_level,index3) in coa_setting_third_level">
                                    <template v-for="(coa_setting,rid) in coa_setting_forth_level"
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-7 col-sm-6 col-xs-12">
                              <select v-model="form1.custom_level_four"
                                ...
                                <option disabled value="0">--Select--</option>
                                <template
                                    v-for="(coa_setting_forth_level,index3) in custom_coa_setting_sub_level[form1.custom_level_three]">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="modelClose()">Close
                  </button>
