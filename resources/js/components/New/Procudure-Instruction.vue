                ...
                <div class="form-box-outer">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 active">
                      <button type="button" v-if="form.procedure_instruction==1" class="btn btn-primary">Procedures
                      </button>
                      <button type="button" @click="change_procudure(1)" class="btn btn-secondary" v-else>Procedures
                      </button>

                      <button type="button" v-if="form.procedure_instruction==2" class="btn btn-primary">Instruction
                      </button>
                      <button type="button" @click="change_procudure(2)" class="btn btn-secondary" v-else>Instruction
                      </button>

                      <button type="button" v-if="form.procedure_instruction==3" class="btn btn-primary">Training
                      </button>
                      <button type="button" @click="change_procudure(3)" class="btn btn-secondary" v-else>Training
                      </button>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <select v-model="form.subject"
                        ...
                        <option v-for="(rules_policy_law,index) in rules_policy_arr" :value="index">
                          {{ rules_policy_law }}
                        </option>
                      </select>
                    </div>
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="form-box-outer">
                  ...
                  <div class="text-center">
                    ...
                    <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                            v-show="editmode" @click.prevent="deleteRulesPolicy()">Delete
                    </button>
                    <button :disabled="form.busy" type="submit" class="btn  btn-primary" style="min-width:110px"
  ...
  methods: {
    ...
    fetchRulesPolicyUpdate(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.issued_date = response.data.procedure_instruction_data[0].issued_date && response.data.procedure_instruction_data[0].issued_date !== "" ?
            new Date(response.data.procedure_instruction_data[0].issued_date) : null;
