              ...
              <div class="col-md-8 col-sm-6 col-xs-12">
                <div class="form-box-outer">
                  ...
                  <p>The Terms of Service Agreement is mainly used for legal purposes by companies which provide
                    ...
                    Companies can enforce the terms by refusing service. Customers can enforce by filing a lawsuit or
                    arbitration case if they can show they were actually harmed by a breach of the terms. There is a
                    heightened risk of data going astray during corporate changes, including mergers, divestitures,
                    buyouts, downsizing, etc., when data can be transferred improperly.[3] <br><br>


                    The Terms of Service Agreement is mainly used for legal purposes by companies which provide software
                    or services, such as web browsers, e-commerce, web search engines, social media, and transport
                    services.<br><br>
                    ...
                    arbitration case if they can show they were actually harmed by a breach of the terms. There is a
                    heightened risk of data going astray during corporate changes, including mergers, divestitures,
                    buyouts, downsizing, etc., when data can be transferred improperly.[3] </p>
                  ...
                  <label class="form-check-inline termds">
                    ...
                    I as an authorized person certify that provided information on this account is correct ,completed
                    and prepared by an authorized person from business owner or company director.
                  </label>
                </div>
              </div>
  ...
  methods: {
    ...
    createTermOfAggrement() {
      if (!this.form.diclaration) {
        showAlert("failed!", "Please Aggree with Terms of Aggreement.", "warning");
      }
