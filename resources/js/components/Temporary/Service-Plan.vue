              ...
              <div class="col-md-2 col-sm-12 col-xs-12">
                <div class="form-box-outer">
                  <div class="form-check-inline">
                    <input type="radio" id="monthly" name="is_monthly" value="1" v-model="form.is_monthly"
                           :checked="form.is_monthly==1" v-on:change="change_peroid(true)">
                    <label for="monthly">Monthly</label><br>
                    <input type="radio" id="yearly" name="is_monthly" value="2" v-model="form.is_monthly"
                           v-on:change="change_peroid(false)" :checked="form.is_monthly==0">
  ...
  methods: {
    ...
    createServicePlan() {
      if (this.form.total_monthly_amount > 0) {
        ...
        showAlert("failed!", "Please Complete You Plan First.You Have Not Select Any Plan", "warning");
      }
    }
  }
}
