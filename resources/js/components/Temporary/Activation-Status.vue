<template>
  <fieldset>
    <form @submit.prevent="createTermOfAggrement()" @keydown="form.onKeydown($event)">
            ...
            <div class="row">
                ...
                <div class="form-box-outer">
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tr>
                        <th>On Hold</th>
                        <td class="text-center" style="color:green" v-if="activation_status==2"><i
                            class="fa fa-check"></i></td>
                        <td class="text-center" style="color:red" v-else><i class="fa fa-times"></i></td>
                      </tr>
                      <tr>
                        <th>Active</th>
                        <td class="text-center" style="color:green" v-if="activation_status==1"><i
                            class="fa fa-check"></i></td>
                        <td class="text-center" style="color:red" v-else><i class="fa fa-times"></i></td>
                      </tr>
                      <tr>
                        <th>Suspend</th>
                        <td class="text-center" style="color:green" v-if="activation_status==3"><i
                            class="fa fa-check"></i></td>
                        <td class="text-center" style="color:red" v-else><i class="fa fa-times"></i></td>
                      </tr>
                      <tr>
                        <th>Canceled</th>
                        <td class="text-center" style="color:green" v-if="activation_status==4"><i
                            class="fa fa-check"></i></td>
                        <td class="text-center" style="color:red" v-else><i class="fa fa-times"></i></td>
                      </tr>
                      <tr v-if="activation_status!=1">
                        <td colspan="2">
                          <button class="btn btn-primary" type="button">Please call 1- 800-888-8988 to get your
                            activation code after 2 business days
                          </button>
                        </td>
                      </tr>
                      </tbody>
              ...
              <div class=" col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="form-box-outer" v-else-if="activation_status==2">
                  <h4 class="text-center">Activation Message</h4>
                  <p align="center"><i class="fa fa-times-circle" style="font-size:60px; color:red;text-center" align="center"></i></p>
      ...
      <button type="submit" class="next action-button" v-show="activation_status==1">Go Next <i
