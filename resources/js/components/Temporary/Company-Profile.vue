<template>
  <fieldset>
    <form @submit.prevent="editmode ? updateCompanyProfile() : createCompanyProfile()"
  ...
  methods: {
    ...
    fetchCompanyProfile() {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.registration_date = response.data.company_data.registration_date ? new Date(response.data.company_data.registration_date) : null;
        ...
        this.form.expirey_date = response.data.company_data.expirey_date ? new Date(response.data.company_data.expirey_date) : null;
