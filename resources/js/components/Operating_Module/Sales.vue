<template>
  <fieldset>
    ...
    <div>
      <form id="msform" @submit.prevent="editmode ? updateSalesOffers() : createCompanyProfile()"
        ...
        <div class="form-card" style="padding:0">
          <div class="text-center">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==1"
                    @click="convert_to_sales_offer(form.id)">Convert To Offer Acceptance
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==2"
                    @click="convert_from_offer_acceptance(form.id)">Convert To Order
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==3"
                    @click="convert_from_order(form.id)">Convert To Packing Slip
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_return==0 && sales_page==4"
                    @click="convert_to_return(form.id)">Convert To Return
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_debit==0 && sales_page==4"
                    @click="convert_to_debit_note(form.id)">Convert To Debit Note
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_credit==0 && sales_page==4"
                    @click="convert_to_credit_note(form.id)">Convert To Credit Note
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==4"
                    @click="convert_to_invoice(form.id)">Convert To Purchase Invoice
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1 && sales_page==8"
                    @click="convert_to_direct_payment(form.id)">Convert To Direct Payment
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1 && sales_page==9"
                    @click="account_statement(form.id)">Account Statement
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_list()" v-if="sales_page==1">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_offer_acceptance_list()" v-else-if="sales_page==2">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_order_list()" v-else-if="sales_page==3">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_packaing_list()" v-else-if="sales_page==4">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_return_list()" v-else-if="sales_page==5">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_debit_list()" v-else-if="sales_page==6">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_credit_list()" v-else-if="sales_page==7">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #sales_type_string="data">
                <span class="font-semibold">{{ data.value.sales_type_string }}</span>
              </template>
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editSalesOffers(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="SalesOffersDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>&nbsp;<span v-if="sales_page==1">Sales Offer:</span>
              <span v-else-if="sales_page==2">Sales Acceptance:</span><span
                  v-else-if="sales_page==3">Sales Order:</span><span v-else-if="sales_page==4">Packing Slip:</span><span
                  v-else-if="sales_page==5">Sales Return:</span><span v-else-if="sales_page==6">Sales Debit Note:</span><span
                  v-else-if="sales_page==7">Sales Credit Note:</span><span
                  v-else-if="sales_page==8">Sales Invoice:</span><span
                  v-else-if="sales_page==9">Direct Receive:</span><span
                  v-else-if="sales_page==10">Account Statement:</span>
          ...
          <div class="text-center" v-if="!list_showable">
            ...
            <button :disabled="form.busy || editmode" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="save_stay(1)">Save-Stay
            </button>
            <button :disabled="form.busy ||editmode" type="button" class="btn  btn-primary" style="min-width:110px"
            ...
            <button :disabled="form.busy || editmode==false || form.posting_status!=0" type="button"
                    class="btn  btn-primary" style="min-width:110px" @click.prevent="deleteSalesOffers()">Delete
            </button>
            ...
            <button :disabled="form.busy || form.posting_status!=1 || form.posting_status!=2" type="button"
          ...
          <div class="modal-body" style="height: 50vh; overflow-y: auto;">
            <div class="form-holder">
              <vue3-datatable :rows="service_item_arr" :columns="service_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                ...
                <template #service_cost="data">
                  <span class="font-semibold">{{ data.value.service_cost }}</span>
                </template>
                <template #sales_tax="data">
                  <span class="font-semibold">{{ data.value.sales_tax }}</span>
                </template>
                <template #tax="data">
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Sales Type', field: 'sales_type_string'},
      ...
      service_columns: ref([
        ...
        {title: 'Purchase Tax', field: 'sales_tax'},
  ...
  methods: {
    ...
    fetchSalesPackaingSlip(offer_id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        response.data.sales_offer_list.schedule_delivery_date !== "" ? new Date(response.data.sales_offer_list.schedule_delivery_date) : null;
        ...
        response.data.sales_offer_list.payment_due_date !== "" ? new Date(response.data.sales_offer_list.payment_due_date) : null;
    ...
    reset_offer_acceptance_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.sales_offer_list);
      });
      this.list_showable = true;
    },
    reset_order_list() {
