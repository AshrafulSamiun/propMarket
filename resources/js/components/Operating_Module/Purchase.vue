<template>
  <fieldset>
            ...
            <ul id="progressbar">
                ...
                <strong>2/10<br>
                  <span>
                                        <a href="javascript:void(0)" @click="change_page(2)" class="router-link ">
                                            <p>Purchase Acceptance({{ total_purchase_offer_acceptance_qty }})</p>
              ...
              <li :class="{ active: purchase_page>=3 }"><strong>3/10<br><span>
                                    <a href="javascript:void(0)" @click="change_page(3)" class="router-link ">
                                        <p>Purchase Order({{ total_purchase_order_qty }})</p>
                                    </a>
                                   </span> </strong>
              </li>
    ...
    <div v-if="purchase_page==1">
      <form id="msform" @submit.prevent="editmode ? updatePurchaseOffers() : createCompanyProfile()"
        ...
        <div class="form-card" style="padding:0">
          <div class="text-center">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0"
                    @click="convert_to_purchase_offer(form.id)">Convert To Offer Acceptance
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_list()">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="postable">Print
            </button>
          </div>
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseOffers(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOffersDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>
                  ...
                  <div class="form-box-outer">
                    ...
                    <div class="form-holder">
                      ...
                      <date-picker
                          ...
                          name="approval_date[]"
                          type="approval_date"
                          :class="{ 'is-invalid': form.errors.has('approval_date') }" />
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Product Details:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_product_info()"
                      v-show="!product_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_product_info()"
                      v-show="product_info_show">Hide
              </button>
            </h3>
                    ...
                    <table class="table table_narrow">
                      ...
                      <template v-for="(single_product,index) in form.product_details_arr">
                        <tr v-if="form.purchase_type==1">
                          ...
                          <td>
                            <button type="button" class="btn  btn-primary" style="min-width:30px"
                                    @click="add_new_product()">Add
                            </button>
          ...
          <div class="text-center" v-if="!list_showable">
            ...
            <button :disabled="form.busy" type="submit" class="btn  btn-primary" style="min-width:110px"
                    v-show="editmode && form.posting_status==0">Edit
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="editmode && form.posting_status==0" @click.prevent="deletePurchaseOffers()">Delete
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="editmode && form.posting_status==0" @click="post()">Post
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="form.posting_status==1 || form.posting_status==2" @click="adjust()">Adjust
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="form.posting_status==2" @click="repost()">RePost
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0"
                    @click="convert_to_purchase_offer(form.id)">Convert To Offer Acceptance
    ...
    <div v-else-if="purchase_page==2">
      <form id="msform" @submit.prevent="editmode ? updatePurchaseOfferAcceptances() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_form()">New {{ form.next_step }}
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0"
                    @click="convert_from_offer_acceptance(form.id)">Convert To Order
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_offer_acceptance_list()">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="postable">Print
            </button>
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseOfferAcceptances(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOfferAcceptancesDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>

          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Offer Acceptance:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="form-box-outer">
                    ...
                    <input v-model="form.service_provider_name"
                           ...
                           name="service_provider_name"
                           placeholder="Browse"
                           :class="{ 'is-invalid': form.errors.has('service_provider_name') }" disabled/>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="form-box-outer">
                    ...
                    <input v-model="form.customer_name"
                           ...
                           name="customer_name"
                           placeholder="Browse"
                           :class="{ 'is-invalid': form.errors.has('customer_name') }" disabled/>
                    ...
                    <table class="table table_narrow">
                      ...
                      <template v-for="(single_charge,index) in form.additional_charge_arr">
                        ...
                        <tr>
                          ...
                          <template v-for="(single_product,index) in form.product_details_arr">
                            <template v-for="(distrubution,dis_id) in single_product.addition_distribution"
                                      v-if="single_charge.reference_id==distrubution.reference_id">
                              <td scope="col" width="120px">
    ...
    <div v-else-if="purchase_page==3">
      <form id="msform" @submit.prevent="editmode ? updatePurchaseOrders() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0"
                    @click="convert_from_order(form.id)">Convert To Packing Slip
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_order_list()">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="postable">Print
            </button>
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseOrders(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOrderDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>

          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Order:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
    ...
    <div v-else-if="purchase_page==4">
      <form id="msform" @submit.prevent="editmode ? updatePurchasPackingSlips() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_return==0"
                    @click="convert_to_return(form.id)">Convert To Return
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_debit==0"
                    @click="convert_to_debit_note(form.id)">Convert To Debit Note
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_credit==0"
                    @click="convert_to_credit_note(form.id)">Convert To Credit Note
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0"
                    @click="convert_to_invoice(form.id)">Convert To Purchase Invoice
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_packaing_list()">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="postable">Print
            </button>
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchasePackingSlips(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOrderDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Packing Slip:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      ...
                      <template v-for="(single_product,index) in form.product_details_arr">
                        <tr v-if="form.purchase_type==1">
                          ...
                          <td>
                            ...
                            <button type="button" class="btn  btn-primary" style="min-width:30px"
                                    @click="remove_product(index)">Remove
                            </button>
          ...
          <div class="text-center" v-if="!list_showable">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_credit==0"
                    @click="convert_to_packing_slip(form.id)">Convert To Credit Note
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0"
                    @click="convert_to_invoice(form.id)">Convert To Purchase Invoice
    ...
    <div v-else-if="purchase_page==5">
      <form id="msform" @submit.prevent="editmode ? updatePurchasReturns() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseReturns(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOrderDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Return:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
    ...
    <div v-else-if="purchase_page==6">
      <form id="msform" @submit.prevent="editmode ? updatePurchasDebitNotes() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseDebitNotes(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOfferDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>

          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Debit Note:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
    ...
    <div v-else-if="purchase_page==7">
      <form id="msform" @submit.prevent="editmode ? updatePurchasCreditNotes() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseCreditNotes(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseOfferDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Credit Note:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
    ...
    <div v-else-if="purchase_page==8">
      <form id="msform" @submit.prevent="editmode ? updatePurchaseInvoices() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1"
                    @click="convert_to_direct_payment(form.id)">Convert To Direct Payment
            </button>

            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_invoice_list()">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="postable">Print
            </button>
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editPurchaseInvoices(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseInvoiceDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>

          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i> Purchase Invoice:
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
                      v-show="!general_info_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_general_info()"
    ...
    <div v-else-if="purchase_page==9">
      <form id="msform" @submit.prevent="editmode ? updateDirectPayments() : createCompanyProfile()"
            @keydown="form.onKeydown($event)">
        <div class="form-card" style="padding:0">
          <div class="text-center">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1"
                    @click="account_statement(form.id)">Account Statement
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="form.unique_no" @click="purchase_summery(form.unique_no)">Purchase Summery
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    @click="reset_payment_list()">List
            </button>
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="postable">Print
            </button>
          ...
          <div v-if="list_showable" class="card-body">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #buttons="data">
                <button class="btn btn-primary btn-sm" @click.prevent="editDirectPayments(data.value.id)">Edit</button>
                <button class="btn btn-danger btn-sm" @click.prevent="PurchaseInvoiceDelete(data.value.id)">Delete</button>
              </template>
            </vue3-datatable>
          </div>

          <div class="form-folder" v-if="summery_showable">
    ...
    <!--  Model  -->
    <div class="modal fade model-middle" id="ServiceItem" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" z-index="1000" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="width:1000px;overflow-y: initial !important">
          ...
          <div class="modal-body" style="height: 50vh; overflow-y: auto;">
            <div class="form-holder">
              <vue3-datatable :rows="service_item_arr" :columns="service_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                <template #sl="data">
                  <strong class="text-info">{{ data.value.sl }}</strong>
                </template>
                <template #system_no="data">
                ...
                <template #service_category_string="data">
                  <span class="font-semibold">{{ data.value.service_category_string }}</span>
                </template>
                <template #service_title="data">
                  <span class="font-semibold">{{ data.value.service_title }}</span>
                </template>
                <template #service_description="data">
                  <span class="font-semibold">{{ data.value.service_description }}</span>
                </template>
                <template #service_provider_name="data">
                  <span class="font-semibold">{{ data.value.service_type }}</span>
                </template>
                <template #customer_name="data">
                  <span class="font-semibold">{{ data.value.service_cost }}</span>
                </template>
                <template #approval_status="data">
                  <span class="font-semibold">{{ data.value.purchase_tax }}</span>
                </template>
                <template #schedule_delivery_date="data">
                  <span class="font-semibold">{{ data.value.tax }}</span>
                </template>
              </vue3-datatable>
            </div>
          </div>
    ...
    <!--  Model  -->
    <div class="modal fade model-middle" id="InventoryItem" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" z-index="1000" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="width:1000px;overflow-y: initial !important">
          <div class="modal-header">
          ...
          <div class="modal-body" style="height: 50vh; overflow-y: auto;">
            <div class="form-holder">
              <vue3-datatable :rows="inventory_item_arr" :columns="inventory_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                <template #sl="data">
                  <strong class="text-info">{{ data.value.sl }}</strong>
                </template>
                <template #system_no="data">
                ...
                <template #item_category_string="data">
                  <span class="font-semibold">{{ data.value.item_category_string }}</span>
                </template>
                <template #item_name="data">
                  <span class="font-semibold">{{ data.value.item_name }}</span>
                </template>
                <template #item_description="data">
                  <span class="font-semibold">{{ data.value.item_description }}</span>
                </template>
                ...
                <template #chart_of_account="data">
                  <span class="font-semibold">{{ data.value.chart_of_account }}</span>
                </template>
              </vue3-datatable>
            </div>
          </div>
  ...
  methods: {
    ...
    fetchPurchasePackaingSlip(offer_id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        response.data.purchase_offer_list.schedule_delivery_date !== "" ? new Date(response.data.purchase_offer_list.schedule_delivery_date) : null;
        ...
        response.data.purchase_offer_list.payment_due_date !== "" ? new Date(response.data.purchase_offer_list.payment_due_date) : null;
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.purchase_offer_list);
      });
        ...
        this.form.post(uri).then(({data}) => {
          ...
          if (response_data[0] == 1) {
            ...
            if (type == 1) {
              ...
              this.form.reset();
              this.fetchPurchaseReturnProfile();
            }
          } else {
            showToast('Invalid Operation', 'error');
          }
        ...
        this.form.post(uri).then(({data}) => {
          ...
          if (response_data[0] == 1) {
            ...
            if (type == 1) {
              ...
              this.form.reset();
              this.fetchPurchaseDebitNoteProfile();
            }
          } else {
            showToast('Invalid Operation', 'error');
          }
        ...
        this.form.post(uri).then(({data}) => {
          ...
          if (response_data[0] == 1) {
            ...
            if (type == 1) {
              ...
              this.form.reset();
              this.fetchPurchaseCreditNoteProfile();
            }
          } else {
            showToast('Invalid Operation', 'error');
          }
        ...
        this.form.post(uri).then(({data}) => {
          ...
          if (response_data[0] == 1) {
            ...
            if (type == 1) {
              ...
              this.form.reset();
              this.fetchPurchaseInvoiceProfile();
            }
          } else {
            showToast('Invalid Operation', 'error');
          }
