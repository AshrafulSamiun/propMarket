        ...
        <form id="msform" @submit.prevent="createPrivileges()" @keydown="form.onKeydown($event)">
          ...
          <div class="card-body">
            <table class="table">
              ...
              <tbody>
              <template v-for="(detail,index) in form.details">
                <tr v-if="detail.rootMenu==0" style="background: rgb(0,112,192);color: #fff;">
              ...
              <template v-for="(detail,index) in form.details">
                <template v-if="detail.position==2">
                  ...
                  <tr v-for="(detail2,index1) in form.details"
                    v-if="detail.main_menu_id==detail2.rootMenu && detail2.position==3">
                  <td scope="row">
                    <div class="custom-control custom-checkbox">
  ...
  methods: {
    ...
    load_module_corresponding_data() {
      if (this.form.user_id == "" || this.form.user_id == 0) {
        showToast('Please Select User Name', 'warning');
        this.form.module_id = "";
        return;
      }
