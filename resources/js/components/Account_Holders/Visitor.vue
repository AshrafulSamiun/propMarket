        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #visitor_name="data">
                <span class="font-semibold">{{ data.value.visitor_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #visitor_email="data">
                <span class="font-semibold">{{ data.value.visitor_email }}</span>
              </template>
              <template #visitor_cell_phone="data">
                <span class="font-semibold">{{ data.value.visitor_cell_phone }}</span>
              </template>
              <template #visitor_country="data">
                <span class="font-semibold">{{ data.value.visitor_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Email', field: 'visitor_email'},
        {title: 'Mobile No', field: 'visitor_cell_phone'},
        {title: 'Country', field: 'visitor_country'},
