        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #share_holder_name="data">
                <span class="font-semibold">{{ data.value.share_holder_name }}</span>
              </template>
              <template #share_holder_position="data">
                <span class="font-semibold">{{ data.value.share_holder_position }}</span>
              </template>
              <template #email="data">
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Board of Director Name', field: 'share_holder_name'},
        {title: 'Position', field: 'share_holder_position'},
