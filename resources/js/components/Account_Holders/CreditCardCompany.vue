        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #credit_card_company_name="data">
                <span class="font-semibold">{{ data.value.credit_card_company_name }}</span>
              </template>
              <template #card_type="data">
                <span class="font-semibold">{{ data.value.card_type }}</span>
              </template>
              <template #email="data">
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Company Name', field: 'credit_card_company_name'},
