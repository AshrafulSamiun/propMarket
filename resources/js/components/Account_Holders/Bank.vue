          ...
          <div class="form-card" v-if="!list_showable">
                    ...
                    <div class="form-box-outer">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <span v-if="form.errors.has('email')" class="text-danger">{{ form.errors.get('email') }}</span>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="text-center" v-if="!list_showable">
              ...
              <button :disabled="form.busy || editmode==false || form.posting_status!=0" type="button"
                      class="btn  btn-primary" style="min-width:110px" @click.prevent="deleteAccountHolder()">Delete
              </button>
  ...
  methods: {
    ...
    editAccountHolder(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.account_creation_date = response.data.account_holder.account_creation_date && response.data.account_holder.account_creation_date !== "" ? new Date(response.data.account_holder.account_creation_date) : null;
