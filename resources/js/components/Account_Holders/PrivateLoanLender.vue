        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #privateloanlender_name="data">
                <span class="font-semibold">{{ data.value.privateloanlender_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #privateloanlender_email="data">
                <span class="font-semibold">{{ data.value.privateloanlender_email }}</span>
              </template>
              <template #privateloanlender_cell_phone="data">
                <span class="font-semibold">{{ data.value.privateloanlender_cell_phone }}</span>
              </template>
              <template #privateloanlender_country="data">
                <span class="font-semibold">{{ data.value.privateloanlender_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'privateloanlender Name', field: 'privateloanlender_name'},
        {title: 'Company Name', field: 'company_name'},
        {title: 'Email', field: 'privateloanlender_email'},
        {title: 'Mobile No', field: 'privateloanlender_cell_phone'},
        {title: 'Country', field: 'privateloanlender_country'},
    ...
    deleteAccountHolder() {
      Swal.fire({
        ...
        this.form.delete('/AccountHolderPrivateLoanLender/' + this.form.id).then(() => {
          if (result.value) {
            showAlert("Deleted!", "Your Company has been deleted.", "success");
            this.form.reset();
            this.fetchAccountHolder();
          }
        }).catch(() => {
