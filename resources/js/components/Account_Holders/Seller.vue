        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #seller_email="data">
                <span class="font-semibold">{{ data.value.seller_email }}</span>
              </template>
              <template #seller_cell_phone="data">
                <span class="font-semibold">{{ data.value.seller_cell_phone }}</span>
              </template>
              <template #seller_country="data">
                <span class="font-semibold">{{ data.value.seller_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Mobile No', field: 'seller_cell_phone'},
        {title: 'Country', field: 'seller_country'},
