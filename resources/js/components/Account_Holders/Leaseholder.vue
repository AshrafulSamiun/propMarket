        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #lease_holder_name="data">
                <span class="font-semibold">{{ data.value.lease_holder_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #lease_holder_email="data">
                <span class="font-semibold">{{ data.value.lease_holder_email }}</span>
              </template>
              <template #lease_holder_cell_phone="data">
                <span class="font-semibold">{{ data.value.lease_holder_cell_phone }}</span>
              </template>
              <template #lease_holder_country="data">
                <span class="font-semibold">{{ data.value.lease_holder_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'lease_holder Name', field: 'lease_holder_name'},
        {title: 'Company Name', field: 'company_name'},
        {title: 'Email', field: 'lease_holder_email'},
        {title: 'Mobile No', field: 'lease_holder_cell_phone'},
        {title: 'Country', field: 'lease_holder_country'},
