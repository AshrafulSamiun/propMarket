        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #entity_type="data">
                <span class="font-semibold">{{ data.value.entity_type }}</span>
              </template>
              <template #full_name="data">
                <span class="font-semibold">{{ data.value.full_name }}</span>
              </template>
              <template #email="data">
          ...
          <div class="form-card" v-if="!list_showable">
                    ...
                    <div class="form-box-outer">
                      ...
                      <div class="position-relative form-group">
                        <select v-model="form.entity_type"
                          ...
                          <option value="" disabled style="background-color:#3C67D4;color:#fff">Registered Corporation
                          </option>
            ...
            <div class="form-folder">
              <h3><i class="fa fa-hand-point-right"></i>Business Licence:
                <button type="button" class="btn btn-primary btn-sm" @click="show_hide_business_license()"
                        v-show="!business_license_show">Show
                </button>
                <button type="button" class="btn btn-primary btn-sm" @click="show_hide_business_license()"
                        v-show="business_license_show">Hide
                </button>
              </h3>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0">
                              <div class="form-check-inline">
                                <button
                                    ...
                                    v-if="form.business_license_is_callender">Remove From Calender
                                </button>
            ...
            <div class="form-folder">
              <h3><i class="fa fa-hand-point-right"></i>Professional Licence:
                <button type="button" class="btn btn-primary btn-sm" @click="show_hide_professional_license()"
                        v-show="!professional_license_show">Show
                </button>
                <button type="button" class="btn btn-primary btn-sm" @click="show_hide_professional_license()"
                        v-show="professional_license_show">Hide
                </button>
              </h3>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0">
                              <div class="form-check-inline">
                                <button
                                    ...
                                    v-if="form.professional_license_is_callender">Remove From Calender
                                </button>
            ...
            <div class="form-folder">
              <h3><i class="fa fa-hand-point-right"></i>Liability Insurance:
                ...
                <button type="button" class="btn btn-primary btn-sm" @click="show_hide_liability_insurence()"
                        v-show="!liability_insurence_show">Show
                </button>
                <button type="button" class="btn btn-primary btn-sm" @click="show_hide_liability_insurence()"
                        v-show="liability_insurence_show">Hide
                </button>
              </h3>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0">
                              <div class="form-check-inline">
                                <button
                                    ...
                                    v-if="form.liabilities_insurence_is_callender">Remove From Calender
                                </button>
  ...
  data() {
    return {
      ...
      form: new Form({
        ...
        business_license_expire_date: null,
        ...
        professional_license_issue_date: null,
        ...
        liabilities_insurence_issue_date: null,
        liabilities_insurence_expire_date: null,
  ...
  methods: {
    ...
    editAccountHolder(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.business_license_issue_date = response.data.account_holder.business_license_issue_date && response.data.account_holder.business_license_issue_date !== "" ?
            new Date(response.data.account_holder.business_license_issue_date) : null;
        this.form.business_license_expire_date = response.data.account_holder.business_license_expire_date && response.data.account_holder.business_license_expire_date !== "" ?
            new Date(response.data.account_holder.business_license_expire_date) : null;
        ...
        this.form.professional_license_issue_date = response.data.account_holder.professional_license_issue_date && response.data.account_holder.professional_license_issue_date !== "" ?
            new Date(response.data.account_holder.professional_license_issue_date) : null;
        this.form.professional_license_expire_date = response.data.account_holder.professional_license_expire_date && response.data.account_holder.professional_license_expire_date !== "" ?
            new Date(response.data.account_holder.professional_license_expire_date) : null;
        ...
        this.form.liabilities_insurence_issue_date = response.data.account_holder.liabilities_insurence_issue_date && response.data.account_holder.liabilities_insurence_issue_date !== "" ?
            new Date(response.data.account_holder.liabilities_insurence_issue_date) : null;
        this.form.liabilities_insurence_expire_date = response.data.account_holder.liabilities_insurence_expire_date && response.data.account_holder.liabilities_insurence_expire_date !== "" ?
            new Date(response.data.account_holder.liabilities_insurence_expire_date) : null;
