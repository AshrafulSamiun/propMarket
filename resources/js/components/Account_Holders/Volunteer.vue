        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #volunteer_name="data">
                <span class="font-semibold">{{ data.value.volunteer_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #volunteer_email="data">
                <span class="font-semibold">{{ data.value.volunteer_email }}</span>
              </template>
              <template #volunteer_cell_phone="data">
                <span class="font-semibold">{{ data.value.volunteer_cell_phone }}</span>
              </template>
              <template #volunteer_country="data">
                <span class="font-semibold">{{ data.value.volunteer_country }}</span>
              </template>
