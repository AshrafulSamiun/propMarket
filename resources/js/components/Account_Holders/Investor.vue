          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #goverment_name="data">
                <span class="font-semibold">{{ data.value.investor_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #investor_email="data">
                <span class="font-semibold">{{ data.value.investor_email }}</span>
              </template>
              <template #investor_cell_phone="data">
                <span class="font-semibold">{{ data.value.investor_cell_phone }}</span>
              </template>
              <template #investor_country="data">
                <span class="font-semibold">{{ data.value.investor_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'investor Name', field: 'investor_name'},
        {title: 'Company Name', field: 'company_name'},
        {title: 'Email', field: 'investor_email'},
        {title: 'Mobile No', field: 'investor_cell_phone'},
        {title: 'Country', field: 'investor_country'},
