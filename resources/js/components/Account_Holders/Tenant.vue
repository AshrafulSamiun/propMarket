        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
              ...
              <template #tenant_name="data">
                <span class="font-semibold">{{ data.value.tenant_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #tenant_email="data">
                <span class="font-semibold">{{ data.value.tenant_email }}</span>
              </template>
              <template #tenant_cell_phone="data">
                <span class="font-semibold">{{ data.value.tenant_cell_phone }}</span>
              </template>
              <template #tenant_country="data">
                <span class="font-semibold">{{ data.value.tenant_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Email', field: 'tenant_email'},
        {title: 'Mobile No', field: 'tenant_cell_phone'},
        {title: 'Country', field: 'tenant_country'},
