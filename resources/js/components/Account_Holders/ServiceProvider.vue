        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #service_provider_email="data">
                <span class="font-semibold">{{ data.value.service_provider_email }}</span>
              </template>
              <template #service_provider_cell_phone="data">
                <span class="font-semibold">{{ data.value.service_provider_cell_phone }}</span>
              </template>
              <template #service_provider_country="data">
                <span class="font-semibold">{{ data.value.service_provider_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      form: new Form({
        ...
        professional_license_renewal_date: null,
      ...
      columns: ref([
        ...
        {title: 'service_provider Name', field: 'service_provider_name'},
        {title: 'Company Name', field: 'company_name'},
        {title: 'Email', field: 'service_provider_email'},
        {title: 'Mobile No', field: 'service_provider_cell_phone'},
        {title: 'Country', field: 'service_provider_country'},
  ...
  methods: {
    ...
    editAccountHolder(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.professional_license_renewal_date = response.data.account_holder.professional_license_renewal_date && response.data.account_holder.professional_license_renewal_date !== "" ?
            new Date(response.data.account_holder.professional_license_renewal_date) : null;
