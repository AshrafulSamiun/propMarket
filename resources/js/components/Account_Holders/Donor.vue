        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #donor_name="data">
                <span class="font-semibold">{{ data.value.donor_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #donor_email="data">
                <span class="font-semibold">{{ data.value.donor_email }}</span>
              </template>
              <template #donor_cell_phone="data">
                <span class="font-semibold">{{ data.value.donor_cell_phone }}</span>
              </template>
              <template #donor_country="data">
                <span class="font-semibold">{{ data.value.donor_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'donor Name', field: 'donor_name'},
        {title: 'Company Name', field: 'company_name'},
        {title: 'Email', field: 'donor_email'},
        {title: 'Mobile No', field: 'donor_cell_phone'},
        {title: 'Country', field: 'donor_country'},
