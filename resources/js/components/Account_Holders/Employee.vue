        ...
        <div id="content">
          ...
          <div v-if="list_showable" class="form-card">
            ...
            <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
              ...
              <template #employee_name="data">
                <span class="font-semibold">{{ data.value.employee_name }}</span>
              </template>
              <template #company_name="data">
                <span class="font-semibold">{{ data.value.company_name }}</span>
              </template>
              <template #employee_email="data">
                <span class="font-semibold">{{ data.value.employee_email }}</span>
              </template>
              <template #employee_cell_phone="data">
                <span class="font-semibold">{{ data.value.employee_cell_phone }}</span>
              </template>
              <template #employee_country="data">
                <span class="font-semibold">{{ data.value.employee_country }}</span>
              </template>
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Mobile No', field: 'employee_cell_phone'},
        {title: 'Country', field: 'employee_country'},
