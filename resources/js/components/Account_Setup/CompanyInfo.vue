            ...
            <fieldset>
              ...
              <table width="100%" class="">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.strata_name" type="text" name="strata_name" class="form-control"
                             :class="{ 'is-invalid': form.errors.has('strata_name') }">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <button
                          ...
                          @click.prevent="addCompanylogo()">Browse
                      </button>
                    </div>
                  </td>
                  <td>
            ...
            <fieldset>
              ...
              <table width="100%" class="">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.contact_person_departnemt" type="text" name="contact_person_departnemt"
                             class="form-control"
                             :class="{ 'is-invalid': form.errors.has('contact_person_departnemt') }">
                    </div>
                  </td>
                  <td>
                    <div class="form-lebel" align="right">
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.contact_person_position" type="text" name="contact_person_position"
                             class="form-control" :class="{ 'is-invalid': form.errors.has('contact_person_position') }">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.contact_person_billing_email" type="text" name="contact_person_billing_email"
                             class="form-control"
                             :class="{ 'is-invalid': form.errors.has('contact_person_billing_email') }">
                    </div>
                  </td>
                  <td>
                    <div class="form-lebel" align="right">
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.contact_person_support_email" type="text" name="contact_person_support_email"
                             class="form-control"
                             :class="{ 'is-invalid': form.errors.has('contact_person_support_email') }">
                    </div>
                  </td>
                  <td>
                    <div class="form-lebel" align="right">
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.contact_person_office_phone" type="text" name="contact_person_office_phone"
                             class="form-control"
                             :class="{ 'is-invalid': form.errors.has('contact_person_office_phone') }">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input v-model="form.contact_person_cell_phone" type="text" name="contact_person_cell_phone"
                             class="form-control"
                  ...
                  <td>
                    <button
                        ...
                        @click.prevent="addContactPerson()">Add Contact Person
                    </button>
                    <button
                        class="btn btn-info fullpwidth" v-show="editContactPerson"
                        @click.prevent="changeContactPerson(updated_contact_person_row)">Change Contact Person
                    </button>
                  </td>
                </tr>
                </tbody>
              ...
              <table align="center">
                ...
                <tr>
                  <td align="center">
                    <div class="form-group">
                      <button :disabled="form.busy" v-show="!editmode" type="submit" class="btn btn-primary">Save
                        Company
                      </button>
  ...
  methods: {
    ...
    createImage() {
      ...
      axios.post('/image/store', {
        ...
        image_file_name: 'company_logo',
        image_folder_name: 'account_company_logo'
      }).then(({data}) => {
    ...
    updateImage() {
      ...
      axios.post('/image/update', {
        image: this.company_logo,
        img_id: this.form.company_logo_id,
        image_file_name: 'company_logo',
        image_folder_name: 'account_company_logo'
      }).then(({data}) => {
    ...
    addContactPerson() {
      ...
      if (this.form.contact_person_name == "") {
        showToast('Please write Name.', 'warning');
        return;
      }

      if (this.form.contact_person_departnemt == "") {
        showToast('Please write Department.', 'warning');
        return;
      }
      if (this.form.contact_person_position == "") {
        showToast('Please write Position.', 'warning');
        return;
      }
      if (this.form.contact_person_billing_email == "") {
        showToast('Please write Billing Email.', 'warning');
        return;
      }
      if (this.form.contact_person_office_phone == "") {
        showToast('Please write Office Phone.', 'warning');
        return;
      }
