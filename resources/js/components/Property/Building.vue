                    ...
                    <table class="table table_narrow">
                      ...
                      <template v-for="(category_contact_details,index) in form.building_contact_details_arr">
                        <template v-if="index > 0">
                          ...
                          <template v-for="(contact_details,subIndex) in category_contact_details" >
                            <tr style="background-color: #e7e8e7">
                              ...
                              <td>
                                <input
                                    ...
                                    v-bind:id="'contact_no_'+subIndex"
                                    name="contact_no[]"
                              ...
                              <td>
                                <input
                                    ...
                                    v-bind:id="'hours_of_operation_'+subIndex"
  ...
  methods: {
    editBuildingInfo(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.safety_item_list_arr = response.data.safety_item_list_arr.map(item => {
          return {
            ...item,
            expiry_date: item.expiry_date && item.expiry_date !== "" ? new Date(item.expiry_date) : null,
            renew_date: item.renew_date && item.renew_date !== "" ? new Date(item.renew_date) : null,
            due_on: item.due_on && item.due_on !== "" ? new Date(item.due_on) : null
          };
        });
    ...
    generate_floor(type) {
      ...
      if (!this.form.number_of_floor) {
        showToast('Please Select Number of Floors First', 'warning');
      ...
      if (total_floor2 > total_floor) {
        showToast('Total Number of Rof Top, Upper Floors,Ground Floor and Under Ground Can not be more than Total Number of Floors.', 'warning');
      ...
      if (type == 2) {
        ...
        if (!this.form.number_of_roof_top) {
          showToast('Please Select Number of Roof Top First', 'warning');
          this.form.number_of_upper_floor = "";
          return;
        }
        //this.form.upper_building_arr=[];
      ...
      if (type == 3) {
        ...
        if (!this.form.number_of_upper_floor) {
          showToast('Please Select Number of Upper Floors First', 'warning');
          this.form.number_of_ground_floor = "";
          return;
        }
      ...
      if (type == 4) {
        ...
        if (!this.form.number_of_ground_floor) {
          showToast('Please Select Number of Ground Floors First', 'warning');
          this.form.number_of_under_ground = "";
          return;
        }
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.safety_item_list_arr = response.data.safety_item_list_arr.map(item => {
          return {
            ...
            expiry_date: item.expiry_date && item.expiry_date !== "" ? new Date(item.expiry_date) : null,
            renew_date: item.renew_date && item.renew_date !== "" ? new Date(item.renew_date) : null,
            due_on: item.renew_date && item.due_on !== "" ? new Date(item.due_on) : null
          };
        });
        this.external_service_provider_list_arr = response.data.external_service_provider_list_arr;
        this.building_contact_list_arr = response.data.building_contact_list_arr;
      ...
      window.axios.get(uri).then((response) => {
        ...
        this.form.safety_item_list_arr = response.data.safety_item_list_arr.map(item => {
          return {
            ...
            expiry_date: item.expiry_date && item.expiry_date !== "" ? new Date(item.expiry_date) : null,
            renew_date: item.renew_date && item.renew_date !== "" ? new Date(item.renew_date) : null,
            due_on: item.renew_date && item.renew_date !== "" ? new Date(item.due_on) : null,
          };
        });
        ...
        for (let i = 0; i < response.data.safety_device_equipment_arr.length; i++) {
          ...
          if (response.data.safety_device_equipment_arr[i].item_id == 1) {
            this.form.fire_extinguisher_details_arr.push({
              ...
              'expiry_date': response.data.safety_device_equipment_arr[i].expiry_date ? new Date(response.data.safety_device_equipment_arr[i].expiry_date) : null,
              'renew_date': response.data.safety_device_equipment_arr[i].renew_date ? new Date(response.data.safety_device_equipment_arr[i].renew_date) : null,
              'cicle': response.data.safety_device_equipment_arr[i].cicle,
              'due_on': response.data.safety_device_equipment_arr[i].due_on ? new Date(response.data.safety_device_equipment_arr[i].due_on) : null,
