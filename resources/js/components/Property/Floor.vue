      ...
      <div class="form-card">
        ...
        <div v-if="list_showable" class="card-body">
          ...
          <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
            ...
            <template #floor_name="data">
              <span class="font-semibold">{{ data.value.floor_name }}</span>
            </template>
            <template #buttons="data">
              <button class="btn btn-primary btn-sm" @click.prevent="editFloor(data.value.id)">Edit</button>
              <button class="btn btn-danger btn-sm" @click.prevent="FloorDelete(data.value.id)">Delete</button>
            </template>
          </vue3-datatable>
        </div>
        <div v-if="!list_showable">
                    ...
                    <table class="table table_narrow">
                        ...
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            ...
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[1].collupseble" @click="collupsable_property(1)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[1].collupseble" @click="collupsable_property(1)">Hide
                            </button>
                          </td>
                          <td width="" align="right"><h4>{{ form.total_suite }}</h4></td>
                        </tr>
                        <template v-for="(single_suite,index) in form.subrooms_list_details_arr[1]">
                          <tr v-show="property_expression[1].collupseble"
                              style="background-color: rgba(121, 137, 175, 0.15)">
                            <td width="" scope="row" style="padding-left:10% !important;"><h5><strong>Residential Suite
                              No {{ form.floor_name_string }}-{{ index.padStart(2, "0") }}</strong></h5></td>
                            ...
                            <td width="">
                              <button type="button" class="btn btn-primary btn-sm"
                                      v-show="!suite_expression[index-1].collupseble"
                                      @click="collupsable_suite(1,index)">Show
                              </button>

                              <button type="button" class="btn btn-primary btn-sm"
                                      v-show="suite_expression[index-1].collupseble"
                                      @click="collupsable_suite(1,index)">Hide
                              </button>
                            </td>
                          </tr>
                          <tr v-show="suite_expression[index-1].collupseble && property_expression[1].collupseble"
                              style="background-color: rgba(135, 165, 235, 0.15);">
                            <td width="" scope="row" style="padding-left:20% !important;"><h6><strong>Subrooms</strong>
                            </h6></td>
                            <td width=""></td>
                            <td width=""></td>
                          </tr>
                          ...
                          <template v-for="(subroom,subroom_id) in form.subrooms_list_details_arr[1][index]">
                            <tr v-show="suite_expression[index-1].collupseble && property_expression[1].collupseble">
                              <td width="60%" scope="row" style="padding-left:30% !important">
                                <strong>{{ subroom.item_name }}</strong></td>
                              <td width="20%">
                      ...
                      <template v-if="form.total_unit>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[2].collupseble" @click="collupsable_property(2)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[2].collupseble" @click="collupsable_property(2)">Hide
                            </button>
                          </td>
                          <td align="right"><h4>{{ form.total_unit }}</h4></td>
                        </tr>
                        <template v-for="(single_suite,index) in form.subrooms_list_details_arr[2]">
                          <tr v-show="property_expression[2].collupseble"
                              style="background-color: rgba(121, 137, 175, 0.15)">
                            <td width="" scope="row" style="padding-left:10% !important;"><h5><strong>Commercial Unit No
                              {{ form.floor_name_string }}-{{ index.padStart(2, "0") }}</strong></h5></td>
                            ...
                            <td width="">
                              <button type="button" class="btn btn-primary btn-sm"
                                      v-show="!unit_expression[index-1].collupseble" @click="collupsable_unit(1,index)">
                                Show
                              </button>
                      ...
                      <template v-if="form.total_mechanical_room>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[7].collupseble" @click="collupsable_property(7)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[7].collupseble" @click="collupsable_property(7)">Hide
                            </button>
                          </td>
                        ...
                        <template v-for="(subroom,subroom_id) in form.subrooms_list_details_arr[7]">
                          <tr v-show="property_expression[7].collupseble">
                            <td width="60%" scope="row" style="padding-left:10% !important">
                              <strong>{{ subroom.item_name }}</strong></td>
                            <td width="20%">
                              <input v-model="subroom.item_qty"
                                     type="number"
                      ...
                      <template v-if="form.total_administrative_room>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[8].collupseble" @click="collupsable_property(8)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[8].collupseble" @click="collupsable_property(8)">Hide
                            </button>
                          </td>
                      ...
                      <template v-if="form.total_amenity_room>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[9].collupseble" @click="collupsable_property(9)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[9].collupseble" @click="collupsable_property(9)">Hide
                            </button>
                          </td>
                      ...
                      <template v-if="form.total_service_room>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[10].collupseble" @click="collupsable_property(10)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[10].collupseble" @click="collupsable_property(10)">Hide
                            </button>
                          </td>
                      ...
                      <template v-if="form.total_parking_lot>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[3].collupseble" @click="collupsable_property(3)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[3].collupseble" @click="collupsable_property(3)">Hide
                            </button>
                          </td>
                        ...
                        <template v-for="(single_parking_lot,parking_index) in form.subrooms_list_details_arr[3]">
                          ...
                          <tr v-show="property_expression[3].collupseble"
                              style="background-color: rgba(121, 137, 175, 0.15)">
                            <td width="" scope="row" style="padding-left:10% !important;"><h5><strong>Parking Level
                              {{ form.floor_name_string }}-{{ parking_index.padStart(2, "0") }}</strong></h5></td>
                            <td width=""></td>
                            <td width=""></td>
                          </tr>
                          ...
                          <template v-for="(subroom,subroom_id) in form.subrooms_list_details_arr[3][parking_index]">
                            <tr v-show="property_expression[3].collupseble">
                              <td width="60%" scope="row" style="padding-left:20% !important">
                                <strong>{{ subroom.item_name }}</strong></td>
                              <td width="20%">
                                <input v-model="subroom.item_qty"
                                       type="number"
                      ...
                      <template v-if="form.total_parking_lot>0">
                        ...
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[4].collupseble" @click="collupsable_property(4)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[4].collupseble" @click="collupsable_property(4)">Hide
                            </button>
                          </td>
                        ...
                        <template v-for="(single_bike_lot,bike_index) in form.subrooms_list_details_arr[4]">
                          ...
                          <tr v-show="property_expression[4].collupseble"
                              style="background-color: rgba(121, 137, 175, 0.15)">
                            <td width="" scope="row" style="padding-left:10% !important;"><h5><strong>Bike Level
                              {{ form.floor_name_string }}-{{ bike_index.padStart(2, "0") }}</strong></h5></td>
                            <td width=""></td>
                            <td width=""></td>
                          </tr>
                      ...
                      <template v-if="form.total_storage_lot>0">
                        ...
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[5].collupseble" @click="collupsable_property(5)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[5].collupseble" @click="collupsable_property(5)">Hide
                            </button>
                          </td>
                        ...
                        <template v-for="(single_storage_lot,storage_index) in form.subrooms_list_details_arr[5]">
                          ...
                          <tr v-show="property_expression[5].collupseble"
                              style="background-color: rgba(121, 137, 175, 0.15)">
                            <td width="" scope="row" style="padding-left:10% !important;"><h5><strong>Storage Lot
                              {{ form.floor_name_string }}-{{ storage_index.padStart(2, "0") }}</strong></h5></td>
                            <td width=""></td>
                            <td width=""></td>
                          </tr>
                      ...
                      <template v-if="form.total_mailroom>0">
                        ...
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[6].collupseble" @click="collupsable_property(6)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[6].collupseble" @click="collupsable_property(6)">Hide
                            </button>
                          </td>
                        ...
                        <template v-for="(single_mailroom,mailroom_index) in form.subrooms_list_details_arr[6]">
                          ...
                          <tr v-show="property_expression[6].collupseble"
                              style="background-color: rgba(121, 137, 175, 0.15)">
                            <td width="" scope="row" style="padding-left:10% !important;"><h5><strong>Mail Room
                              {{ form.floor_name_string }}-{{ mailroom_index.padStart(2, "0") }}</strong></h5></td>
                            <td width=""></td>
                            <td width=""></td>
                          </tr>
                      ...
                      <template v-if="form.total_common_area>0">
                        <tr style="background-color: rgba(41,85,200,0.15);">
                          ...
                          <td width="">
                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="!property_expression[11].collupseble" @click="collupsable_property(11)">Show
                            </button>

                            <button type="button" class="btn btn-primary btn-sm"
                                    v-show="property_expression[11].collupseble" @click="collupsable_property(11)">Hide
                            </button>
                          </td>
          ...
          <div class="text-center" v-if="!list_showable">
            ...
            <button :disabled="form.busy || editmode==false || form.posting_status!=0" type="button"
                    class="btn  btn-primary" style="min-width:110px" @click.prevent="deleteFloor()">Delete
            </button>
...
export default {
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Property Name', field: 'floor_name'},
  ...
  methods: {
    ...
    reset_list() {
      ...
      let uri = '/FloorLists';
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.Floor_list);
      });
