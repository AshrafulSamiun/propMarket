        ...
        <div v-if="list_showable" class="card-body">
          ...
          <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
            ...
            <template #total_suite_size="data">
              <span class="font-semibold">{{ data.value.total_unit_size }}</span>
            </template>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <select v-model="form.unit_no"
                          ...
                          <option v-for="unit in form.total_unit" :value="unit">Unit No
                            {{ form.floor_name_string }}-{{ unit.toString().padStart(2, "0") }}
                          </option>
                        </select>
                      </div>
                    ...
                    <div class="form-holder">
                      <div class="form-check-inline">
                        ...
                        <label for="commercial">Sub Rooms Total Size: {{ form.total_subroom_size }}
                          {{ uom_arr[form.unit_uom] }}</label><br>

                        <input type="radio"
                               id="residential_commercial"
                               name="residential_commercial" disabled>
                        <label for="residential_commercial">Total Unit Size: {{ form.total_unit_size }}
                          {{ uom_arr[form.unit_uom] }}</label><br>
                      </div>
                    </div>
                  </div>
                      ...
                      <template v-if="form.total_unit>0">
                        ...
                        <template v-for="(single_subroom,index) in form.subrooms_list_arr">
                          ...
                          <tr v-if="single_subroom.disable" style="background-color:rgb(228, 233, 230)">
                            <td width="20%" scope="row" style="padding-left:5% !important">
...
export default {
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Total Unit Size', field: 'total_unit_size'},
  ...
  methods: {
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.commercial_unit_list);
      });
