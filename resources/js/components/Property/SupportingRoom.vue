        ...
        <div v-if="list_showable" class="card-body">
          ...
          <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" class="advanced-table whitespace-nowrap">
            ...
            <template #buttons="data">
              <button class="btn btn-primary btn-sm" @click.prevent="editSupportingRooms(data.value.id)">Edit</button>
              <button class="btn btn-danger btn-sm" @click.prevent="SupportingRoomDelete(data.value.id)">Delete</button>
            </template>
          </vue3-datatable>
        </div>
                      ...
                      <template v-if="form.total_mechanical_room>0">
                        ...
                        <template v-for="(single_subroom,index) in form.subrooms_list_arr">
                          <template v-if="single_subroom.item_type==7">
                            <tr>
                              <td width="30%" scope="row" style="padding-left:5% !important">
  ...
  methods: {
    ...
    editSupportingRooms(id) {
      ...
      window.axios.get(uri).then((response) => {
        ...
        if(safety_device_equipment_arr)
        {
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.supporting_room_list);
      });
