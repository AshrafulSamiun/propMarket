      ...
      <div class="form-card">
        ...
        <div v-if="list_showable" class="card-body">
          ...
          <vue3-datatable :rows="rows" :columns="columns" :sortable="true" class="advanced-table whitespace-nowrap">
            ...
            <template #main_company_name="data">
              <span class="font-semibold">{{ data.value.main_company_name }}</span>
            </template>
            <template #sub_company_name="data">
              <span class="font-semibold">{{ data.value.sub_company_name }}</span>
            </template>
            ...
            <template #total_property_size_qty="data">
              <span class="font-semibold">{{ data.value.total_property_size_qty }}</span>
            </template>
            <template #buttons="data">
              <button class="btn btn-primary btn-sm" @click.prevent="editPropertyAttribution(data.value.id)">Edit</button>
            </template>
          </vue3-datatable>
        </div>
        <div v-if="!list_showable">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-box-outer">
                    ...
                    <select v-model="form.main_company"
                      ...
                      <option v-for="(main_company,index) in main_company_arr" :value="index">{{ main_company }}
                      </option>
                    </select>
                      ...
                      <tr align="center">
                        ...
                        <td>
                          <select v-model="form.building_id"
                            ...
                            <option v-for="(building,index) in building_arr" :value="index">{{ building.building_no }}
                            </option>
                          </select>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Residential Suite Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_suite()" v-show="!suite_show">
                Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_suite()" v-show="suite_show">Hide
              </button>
            </h3>
                      ...
                      <tr align="center">
                        <td width="" scope="row">
                          <select v-model="form.suite_type"
                            ...
                            <option value="" style="background-color:rgb(0,112,196);color:#fff" disabled>Standard
                              Suites
                            </option>
                        ...
                        <td>{{ form.suite_floor_no.toString().padStart(2, "0") }} -
                          {{ form.suite_no.toString().padStart(2, "0") }}
                        </td>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Commercial Unit Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_unit()" v-show="!unit_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_unit()" v-show="unit_show">Hide
              </button>
            </h3>
                  ...
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <table class="table table_narrow">
                      ...
                      <tr align="center">
                        ...
                        <td>{{ form.unit_floor_no.toString().padStart(2, "0") }} -
                          {{ form.unit_no.toString().padStart(2, "0") }}
                        </td>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Supporting & Service Room Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_supporting_room()"
                      v-show="!supporting_room_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_supporting_room()"
                      v-show="supporting_room_show">Hide
              </button>
            </h3>
                  ...
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <table class="table table_narrow">
                      ...
                      <template v-if="form.total_machanical_room>0">
                        ...
                        <template v-for="(single_subroom,index) in form.service_room_arr"
                                  v-if="single_subroom.item_type==7">
                          ...
                          <tr>
                            ...
                            <td width="15%" scope="row" style="padding-left:2% !important">
                      ...
                      <template v-if="form.total_administrition_room>0">
                        ...
                        <template v-for="(single_subroom,index) in form.service_room_arr"
                                  v-if="single_subroom.item_type==8">
                          <tr>
                            <td class="form-check-inline">
                              <input type="checkbox"
                                     id="allocated"
                      ...
                      <template v-if="form.total_aminity_room>0">
                        ...
                        <template v-for="(single_subroom,index) in form.service_room_arr"
                                  v-if="single_subroom.item_type==9">
                      ...
                      <template v-if="form.total_service_room>0">
                        ...
                        <template v-for="(single_subroom,index) in form.service_room_arr"
                                  v-if="single_subroom.item_type==10">
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Parking Lot Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_parking()" v-show="!parking_show">
                Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_parking()" v-show="parking_show">
                Hide
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <div class="pull-left" style="margin-top:10px;">
                      <label for="filter" class="sr-only">Filter</label>
                      <input type="text" class="form-control" v-model="filter_parking" placeholder="Filter"
                             style="width:400px;">
                    </div>
                    ...
                    <vue3-datatable :rows="form.parking_stall_arr" :columns="parking_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                      <template #previous_allocated="data">
                        <input
                            v-if="data.value.previous_allocated && data.value.current_allocated == 0"
                            type="checkbox"
                            id="allocated"
                            disabled
                            name="allocated[]"
                      ...
                      <template #floor_no="data">
                        <span class="font-semibold">{{ data.value.floor_no }}</span>
                      </template>
                      <template #allocated_string="data">
                        <span class="font-semibold">{{ data.value.allocated_string }}</span>
                      </template>
                      <template #lot_uom="data">
                        <span class="font-semibold">{{ uom_arr[data.value.lot_uom] }}</span>
                      </template>
                      <template #item_size="data">
                        {{ data.value.item_size.toFixed(2) }}
                      </template>
                    </vue3-datatable>
                  </div>
                </div>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Bike Lot Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_bike()" v-show="!bike_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_bike()" v-show="bike_show">Hide
              </button>
            </h3>
              ...
              <div class="row align-self-stretch">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <div class="pull-left" style="margin-top:10px;">
                      <label for="filter" class="sr-only">Filter</label>
                      <input type="text" class="form-control" v-model="filter_bike" placeholder="Filter"
                             style="width:400px;">
                    </div>
                    <div class="pull-right" style="margin-top:10px;">
                      <table class="table table-narrow">
                    ...
                    <vue3-datatable :rows="form.bike_stall_arr" :columns="bike_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                      <template #previous_allocated="data">
                        <input
                            v-if="data.value.previous_allocated && data.value.current_allocated == 0"
                            type="checkbox"
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Storage Lot Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_storage()" v-show="!storage_show">
                Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_storage()" v-show="storage_show">
                Hide
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <div class="pull-left" style="margin-top:30px;">
                      <label for="filter" class="sr-only">Filter</label>
                      <input type="text" class="form-control" v-model="filter_storage" placeholder="Filter"
                             style="width:400px;">
                    </div>
                    ...
                    <vue3-datatable :rows="form.storage_locker_arr" :columns="storage_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                      <template #previous_allocated="data">
                        <div class="form-check-inline" v-if="data.value.previous_allocated && data.value.current_allocated == 0">
                          <input
                              type="checkbox"
                              id="allocated"
                              disabled
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Mailbox Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_mailroom()"
                      v-show="!mailroom_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_mailroom()" v-show="mailroom_show">
                Hide
              </button>
            </h3>
              ...
              <div class="row align-self-stretch">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <div class="pull-left" style="margin-top:30px;">
                      <label for="filter" class="sr-only">Filter</label>
                      <input type="text" class="form-control" v-model="filter_mailbox" placeholder="Filter"
                             style="width:400px;">
                    </div>
                    <div class="pull-right" style="margin-top:5px;">
                      <table class="table table-narrow">
                    ...
                    <vue3-datatable :rows="form.mail_box_arr" :columns="mail_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                      <template #previous_allocated="data">
                        <div class="form-check-inline" v-if="data.value.previous_allocated && data.value.current_allocated == 0">
                          <input
                              type="checkbox"
                      ...
                      <template #room_uom="data">
                        <span class="font-semibold">{{ uom_arr[data.value.room_uom] }}</span>
                      </template>
                      <template #item_size="data">
                        {{ data.value.item_size.toFixed(2) }}
                      </template>
          ...
          <div class="form-folder">
            <h3><i class="fa fa-hand-point-right"></i>Common Area Details
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_common_area()"
                      v-show="!common_area_show">Show
              </button>
              <button type="button" class="btn btn-primary btn-sm" @click="show_hide_common_area()"
                      v-show="common_area_show">Hide
              </button>
            </h3>
              ...
              <div class="row align-self-stretch">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px">
                  <div class="form-box-outer" style=" width:100%">
                    ...
                    <vue3-datatable :rows="form.common_area_arr" :columns="common_area_columns" :sortable="true" class="advanced-table whitespace-nowrap">
                      <template #allocated="data">
                      ...
                      <template #uom="data">
                        <span class="font-semibold">{{ uom_arr[data.value.uom] }}</span>
                      </template>
                      <template #previous_allocated="data">
                        {{ data.value.previous_allocated.toFixed(2) }}
                      </template>
                      <template #available="data">
                        {{ data.value.available.toFixed(2) }}
                      </template>
                      <template #allocated_size="data">
                        <div class="form-check-inline" v-if="data.value.allocated">
                          <input type="text"
                                 style="width:100%"
                                 @keyup="calculate_common_area(data.value)"
                                 id="allocated_size"
                                 name="allocated_size[]"
                                 v-model="data.value.allocated_size">
                        </div>
                        <div class="form-check-inline" v-else>
                          <input
                              type="checkbox"
          ...
          <div class="text-center" v-if="!list_showable">
            ...
            <button :disabled="form.busy" type="button" class="btn  btn-primary" style="min-width:110px"
                    v-show="editmode" @click.prevent="deletePropertyAttribution()">Delete
            </button>
            <button :disabled="form.busy" type="submit" class="btn  btn-primary" style="min-width:110px"
...
export default {
  ...
  data() {
    return {
      ...
      columns: ref([
        ...
        {title: 'Main - Company', field: 'main_company_name'},
        {title: 'Sub - Company', field: 'sub_company_name'},
        {title: 'Property Customer', field: 'customer_name'},
        {title: 'Building Name', field: 'building_name'},
        {title: 'Master Property ID', field: 'system_no'},
        {title: 'Property Type', field: 'property_type'},
        {title: 'Property Name', field: 'property_name'},
        {title: 'Property Size', field: 'total_property_size_qty'},
      ...
      parking_columns: ref([
        ...
        {title: 'Floor No', field: 'floor_no'},
        {title: 'Status', field: 'allocated_string'},
        {title: 'Size Scale', field: 'lot_uom'},
        {title: 'Size Qty', field: 'item_size'},
      ]),
      ...
      mail_columns: ref([
        ...
        {title: 'Property Name', field: 'property_name'},
        {title: 'Floor No', field: 'floor_no'},
        {title: 'Size Scale', field: 'room_uom'},
        {title: 'Size Qty', field: 'item_size'},
      ]),
      common_area_columns: ref([
        ...
        {title: 'Size Scale', field: 'room_uom'},
        {title: 'Size Qty', field: 'item_size'},
        {title: 'Total Allocated Size', field: 'previous_allocated'},
        {title: 'Available Size', field: 'available'},
        {title: 'Allocated Size', field: 'allocated_size'},
      ]),
  ...
  methods: {
    ...
    reset_list() {
      ...
      window.axios.get(uri).then((response) => {
        this.rows = ref(response.data.property_attribution_list);
      });
