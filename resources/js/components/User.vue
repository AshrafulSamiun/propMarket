        ...
        <div class="row align-self-stretch">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="form-box-outer">
              ...
              <vue3-datatable :rows="rows" :columns="columns" :sortable="true" :search="filter" :hasCheckbox="true" class="advanced-table whitespace-nowrap"></vue3-datatable>
            </div>
          </div>
        </div>
      </div>
