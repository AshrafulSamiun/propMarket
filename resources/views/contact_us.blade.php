...
@section('content')
    ...
    <div style="margin-top:60px; box-shadow: 0px 4px 10px rgba(45, 123, 252, 0.64); display: inline-block;">
     <img src="assets/img/Home/propmarket_78.png" class="img-fluid overlay" alt="">
     </div>
     ...
     <div class="overlay">
        ...
        <!-- <img src="assets/img/Home/propmarket_78.png" class="img-fluid overlay" alt="" style="margin-top:50px"> -->
      ...
      <div class="container about-banner" data-aos="fade-up">
        ...
        <div class="section-title">
          <h3 class="title">Support Information</h3>
